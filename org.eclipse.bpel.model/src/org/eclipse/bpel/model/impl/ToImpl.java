...
public class ToImpl extends ExtensibleElementImpl implements To {
  ...
  public void setVariable(Variable newVariable) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TO__VARIABLE,
  ...
  public Part getPartGen() {
    if (part != null && part.eIsProxy()) {
      ...
      if (part != oldPart) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPELPackage.TO__PART,
              oldPart, part));
      }
    }
    return part;
  ...
  public void setPart(Part newPart) {
    ...
    part = newPart;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TO__PART,
          oldPart, part));
  }
  ...
  public void setPartnerLink(PartnerLink newPartnerLink) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TO__PARTNER_LINK,
  ...
  public void setProperty(Property newProperty) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TO__PROPERTY,
  ...
  public NotificationChain basicSetQuery(Query newQuery, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.TO__QUERY, oldQuery, newQuery);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newQuery != query) {
      ...
      if (query != null)
        msgs = ((InternalEObject) query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.TO__QUERY, null, msgs);
      if (newQuery != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TO__QUERY,
          newQuery, newQuery));
  }
  ...
  public NotificationChain basicSetExpression(Expression newExpression,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.TO__EXPRESSION, oldExpression, newExpression);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newExpression != expression) {
      ...
      if (expression != null)
        msgs = ((InternalEObject) expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.TO__EXPRESSION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TO__EXPRESSION,
