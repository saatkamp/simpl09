...
public class CorrelationSetImpl extends ExtensibleElementImpl implements CorrelationSet {
  ...
  public EList<Property> getProperties() {
    if (properties == null) {
      properties = new EObjectResolvingEList<Property>(Property.class, this,
          BPELPackage.CORRELATION_SET__PROPERTIES);
    }
    return properties;
  }
  ...
  protected void changeReference(EReference reference) {
    if (reference.getFeatureID() == BPELPackage.CORRELATION_SET__PROPERTIES
      ...
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PROPERTIES,
          ElementFactory.getInstance().createPropertiesString(this));
    }
