...
public class MessageExchangesImpl extends ExtensibleElementImpl implements
  ...
  public EList<MessageExchange> getChildren() {
    if (children == null) {
      children = new EObjectContainmentEList<MessageExchange>(MessageExchange.class,
          this, BPELPackage.MESSAGE_EXCHANGES__CHILDREN);
    }
    return children;
  }
  ...
  public void eSet(int featureID, Object newValue) {
    ...
    case BPELPackage.MESSAGE_EXCHANGES__CHILDREN:
      getChildren().clear();
      getChildren().addAll((Collection<? extends MessageExchange>) newValue);
      return;
    }
  ...
  protected void adoptContent(EReference reference, Object object) {
    if (object instanceof MessageExchange) {
      if (getElement() == null) {
        ReconciliationHelper.getInstance().patchParentElement((MessageExchange) object,
            this, null, BPELConstants.ND_MESSAGE_EXCHANGES,
            BPELConstants.ND_MESSAGE_EXCHANGE);
      }
      ReconciliationHelper.adoptChild(this, children, (MessageExchange) object,
          BPELConstants.ND_MESSAGE_EXCHANGE);
    }
