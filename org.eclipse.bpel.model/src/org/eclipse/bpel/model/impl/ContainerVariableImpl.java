 ...
 * </copyright>
 *
 * $Id: ContainerVariableImpl.java,v 1.15 2009/04/14 10:50:37 smoser Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel.model.impl.ContainerVariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.ContainerVariableImpl#getMessageType <em>Message Type</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.ContainerVariableImpl#getXSDElement <em>XSD Element</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.ContainerVariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.ContainerVariableImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContainerVariableImpl extends ExtensibleElementImpl implements ContainerVariable {
  /**
  ...
  public XSDTypeDefinition getType() {
    if (type != null && type.eIsProxy()) {
      ...
      if (type != oldType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.CONTAINER_VARIABLE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public NotificationChain basicSetFrom(From newFrom, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.CONTAINER_VARIABLE__FROM, oldFrom, newFrom);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFrom != from) {
      ...
      if (from != null)
        msgs = ((InternalEObject) from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.CONTAINER_VARIABLE__FROM, null, msgs);
      if (newFrom != null)
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
    case BPELPackage.CONTAINER_VARIABLE__FROM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case BPELPackage.CONTAINER_VARIABLE__NAME:
      return getName();
    case BPELPackage.CONTAINER_VARIABLE__MESSAGE_TYPE:
      if (resolve)
        return getMessageType();
      return basicGetMessageType();
    case BPELPackage.CONTAINER_VARIABLE__XSD_ELEMENT:
      if (resolve)
        return getXSDElement();
      return basicGetXSDElement();
    case BPELPackage.CONTAINER_VARIABLE__TYPE:
      if (resolve)
        return getType();
      return basicGetType();
    case BPELPackage.CONTAINER_VARIABLE__FROM:
