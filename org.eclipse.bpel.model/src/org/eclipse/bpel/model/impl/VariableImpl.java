...
public class VariableImpl extends ExtensibleElementImpl implements Variable {
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.VARIABLE__NAME,
          oldName, name));
  }
      ...
      if (messageType != oldMessageType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.VARIABLE__MESSAGE_TYPE, oldMessageType, messageType));
      }
    }
    return messageType;
  }
  ...
  public XSDElementDeclaration getXSDElement() {
    if (xsdElement != null && xsdElement.eIsProxy()) {
      ...
      if (xsdElement != oldXSDElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.VARIABLE__XSD_ELEMENT, oldXSDElement, xsdElement));
      }
    }
    return xsdElement;
  }
  ...
  public void setType(XSDTypeDefinition newType) {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.VARIABLE__TYPE,
          oldType, type));
  }
  ...
  public NotificationChain basicSetFrom(From newFrom, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.VARIABLE__FROM, oldFrom, newFrom);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFrom != from) {
      ...
      if (from != null)
        msgs = ((InternalEObject) from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.VARIABLE__FROM, null, msgs);
      if (newFrom != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.VARIABLE__FROM,
          newFrom, newFrom));
  }
