...
public class CorrelationImpl extends ExtensibleElementImpl implements Correlation {
  ...
  public void setInitiate(String newInitiate) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.CORRELATION__INITIATE, oldInitiate, initiate, !oldInitiateESet));
  }
  ...
  public void unsetInitiate() {
    String oldInitiate = initiate;
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_INITIATE,
          (String) null);
    }
    boolean oldInitiateESet = initiateESet;
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.CORRELATION__INITIATE, oldInitiate, INITIATE_EDEFAULT,
          oldInitiateESet));
  }
  ...
  public void setPattern(CorrelationPattern newPattern) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PATTERN,
          newPattern == null ? PATTERN_EDEFAULT.getName() : newPattern.getName());
    }
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.CORRELATION__PATTERN, oldPattern, pattern, !oldPatternESet));
  }
  ...
  public void unsetPattern() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.CORRELATION__PATTERN, oldPattern, PATTERN_EDEFAULT, oldPatternESet));
  }
  ...
  public void setSet(CorrelationSet newSet) {
    ...
    set = newSet;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.CORRELATION__SET,
          oldSet, set));
  }
