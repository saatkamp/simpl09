      ...
      if (partnerLink != oldPartnerLink) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.PARTNER_ACTIVITY__PARTNER_LINK, oldPartnerLink, partnerLink));
      }
    }
    return partnerLink;
  }
  ...
  public NotificationChain basicSetCorrelations(Correlations newCorrelations,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PARTNER_ACTIVITY__CORRELATIONS, oldCorrelations, newCorrelations);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newCorrelations != correlations) {
      ...
      if (correlations != null)
        msgs = ((InternalEObject) correlations).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PARTNER_ACTIVITY__CORRELATIONS, null,
            msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PARTNER_ACTIVITY__CORRELATIONS, newCorrelations, newCorrelations));
  }
  ...
  public PortType getPortTypeGen() {
    if (portType != null && portType.eIsProxy()) {
      ...
      if (portType != oldPortType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.PARTNER_ACTIVITY__PORT_TYPE, oldPortType, portType));
      }
    }
    return portType;
  }
  ...
  public Operation getOperationGen() {
    if (operation != null && operation.eIsProxy()) {
      ...
      if (operation != oldOperation) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.PARTNER_ACTIVITY__OPERATION, oldOperation, operation));
      }
    }
    return operation;
  }
