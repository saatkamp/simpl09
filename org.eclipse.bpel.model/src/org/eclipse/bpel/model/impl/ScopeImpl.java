...
public class ScopeImpl extends ActivityImpl implements Scope {
  ...
  public void setIsolated(Boolean newIsolated) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_ISOLATED,
          BPELUtils.boolean2XML(newIsolated));
    }
    boolean oldIsolatedESet = isolatedESet;
    isolatedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.SCOPE__ISOLATED,
          oldIsolated, isolated, !oldIsolatedESet));
  }
  ...
  public void unsetIsolated() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.SCOPE__ISOLATED, oldIsolated, ISOLATED_EDEFAULT, oldIsolatedESet));
  }
  ...
  public NotificationChain basicSetFaultHandlers(FaultHandler newFaultHandlers,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__FAULT_HANDLERS, oldFaultHandlers, newFaultHandlers);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFaultHandlers != faultHandlers) {
      ...
      if (faultHandlers != null)
        msgs = ((InternalEObject) faultHandlers).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__FAULT_HANDLERS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__FAULT_HANDLERS, newFaultHandlers, newFaultHandlers));
  }
  ...
  public NotificationChain basicSetCompensationHandler(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__COMPENSATION_HANDLER, oldCompensationHandler,
          newCompensationHandler);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setCompensationHandler(CompensationHandler newCompensationHandler) {
    if (newCompensationHandler != compensationHandler) {
      ...
      if (compensationHandler != null)
        msgs = ((InternalEObject) compensationHandler).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__COMPENSATION_HANDLER, null, msgs);
      if (newCompensationHandler != null)
        msgs = ((InternalEObject) newCompensationHandler).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__COMPENSATION_HANDLER, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__COMPENSATION_HANDLER, newCompensationHandler,
          newCompensationHandler));
  }
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newActivity != activity) {
      ...
      if (activity != null)
        msgs = ((InternalEObject) activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.SCOPE__ACTIVITY, null, msgs);
      if (newActivity != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.SCOPE__ACTIVITY,
  ...
  public NotificationChain basicSetVariables(Variables newVariables,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__VARIABLES, oldVariables, newVariables);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newVariables != variables) {
      ...
      if (variables != null)
        msgs = ((InternalEObject) variables).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.SCOPE__VARIABLES, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.SCOPE__VARIABLES,
  ...
  public NotificationChain basicSetCorrelationSets(CorrelationSets newCorrelationSets,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__CORRELATION_SETS, oldCorrelationSets, newCorrelationSets);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCorrelationSets != correlationSets) {
      ...
      if (correlationSets != null)
        msgs = ((InternalEObject) correlationSets).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__CORRELATION_SETS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__CORRELATION_SETS, newCorrelationSets, newCorrelationSets));
  }
  ...
  public NotificationChain basicSetEventHandlers(EventHandler newEventHandlers,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__EVENT_HANDLERS, oldEventHandlers, newEventHandlers);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newEventHandlers != eventHandlers) {
      ...
      if (eventHandlers != null)
        msgs = ((InternalEObject) eventHandlers).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__EVENT_HANDLERS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__EVENT_HANDLERS, newEventHandlers, newEventHandlers));
  }
  ...
  public NotificationChain basicSetPartnerLinks(PartnerLinks newPartnerLinks,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__PARTNER_LINKS, oldPartnerLinks, newPartnerLinks);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newPartnerLinks != partnerLinks) {
      ...
      if (partnerLinks != null)
        msgs = ((InternalEObject) partnerLinks).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__PARTNER_LINKS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__PARTNER_LINKS, newPartnerLinks, newPartnerLinks));
  }
  ...
  public NotificationChain basicSetTerminationHandler(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__TERMINATION_HANDLER, oldTerminationHandler,
          newTerminationHandler);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setTerminationHandler(TerminationHandler newTerminationHandler) {
    if (newTerminationHandler != terminationHandler) {
      ...
      if (terminationHandler != null)
        msgs = ((InternalEObject) terminationHandler).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__TERMINATION_HANDLER, null, msgs);
      if (newTerminationHandler != null)
        msgs = ((InternalEObject) newTerminationHandler).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__TERMINATION_HANDLER, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__TERMINATION_HANDLER, newTerminationHandler,
          newTerminationHandler));
  }
    ...
    if (newMessageExchanges != messageExchanges) {
      ...
      if (messageExchanges != null)
        msgs = ((InternalEObject) messageExchanges).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.SCOPE__MESSAGE_EXCHANGES, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__MESSAGE_EXCHANGES, newMessageExchanges, newMessageExchanges));
  }
  ...
  private NotificationChain basicSetMessageExchanges(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__MESSAGE_EXCHANGES, oldMessageExchanges, newMessageExchanges);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setExitOnStandardFault(Boolean newExitOnStandardFault) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SCOPE__EXIT_ON_STANDARD_FAULT, oldExitOnStandardFault,
          exitOnStandardFault, !oldExitOnStandardFaultESet));
  }
  ...
  public void unsetExitOnStandardFault() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.SCOPE__EXIT_ON_STANDARD_FAULT, oldExitOnStandardFault,
          EXIT_ON_STANDARD_FAULT_EDEFAULT, oldExitOnStandardFaultESet));
  }
