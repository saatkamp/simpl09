...
public class OnMessageImpl extends ExtensibleElementImpl implements OnMessage {
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_MESSAGE__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public PartnerLink getPartnerLink() {
    if (partnerLink != null && partnerLink.eIsProxy()) {
      ...
      if (partnerLink != oldPartnerLink) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.ON_MESSAGE__PARTNER_LINK, oldPartnerLink, partnerLink));
      }
    }
    return partnerLink;
  }
  ...
  public NotificationChain basicSetCorrelations(Correlations newCorrelations,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_MESSAGE__CORRELATIONS, oldCorrelations, newCorrelations);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCorrelations != correlations) {
      ...
      if (correlations != null)
        msgs = ((InternalEObject) correlations).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.ON_MESSAGE__CORRELATIONS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_MESSAGE__CORRELATIONS, newCorrelations, newCorrelations));
  }
  ...
  public NotificationChain basicSetFromParts(FromParts newFromParts,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_MESSAGE__FROM_PARTS, oldFromParts, newFromParts);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newFromParts != fromParts) {
      ...
      if (fromParts != null)
        msgs = ((InternalEObject) fromParts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_MESSAGE__FROM_PARTS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_MESSAGE__FROM_PARTS, newFromParts, newFromParts));
  }
  ...
  public void setMessageExchange(MessageExchange newMessageExchange) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_MESSAGE__MESSAGE_EXCHANGE, oldMessageExchange, messageExchange));
  }
