  ...
  public NotificationChain basicSetJoinCondition(Condition newJoinCondition,
    ...
    if (!isReconciling) {
      if (newJoinCondition != null && newJoinCondition.getElement() == null
        ...
        newJoinCondition.setElement(ElementFactory.getInstance().createExpressionElement(
            newJoinCondition, this, BPELConstants.ND_JOIN_CONDITION));
      }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.TARGETS__JOIN_CONDITION, oldJoinCondition, newJoinCondition);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newJoinCondition != joinCondition) {
      ...
      if (joinCondition != null)
        msgs = ((InternalEObject) joinCondition).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.TARGETS__JOIN_CONDITION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.TARGETS__JOIN_CONDITION, newJoinCondition, newJoinCondition));
  }
