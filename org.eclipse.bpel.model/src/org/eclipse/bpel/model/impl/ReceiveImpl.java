...
public class ReceiveImpl extends PartnerActivityImpl implements Receive {
  ...
  public void setCreateInstance(Boolean newCreateInstance) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_CREATE_INSTANCE,
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.RECEIVE__CREATE_INSTANCE, oldCreateInstance, createInstance,
          !oldCreateInstanceESet));
  }
  ...
  public NotificationChain basicSetFromParts(FromParts newFromParts,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.RECEIVE__FROM_PARTS, oldFromParts, newFromParts);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public MessageExchange getMessageExchange() {
    if (messageExchange != null && messageExchange.eIsProxy()) {
      ...
      if (messageExchange != oldMessageExchange) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.RECEIVE__MESSAGE_EXCHANGE, oldMessageExchange, messageExchange));
      }
    }
