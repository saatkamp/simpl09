...
public class SourceImpl extends ExtensibleElementImpl implements Source {
  ...
  public NotificationChain basicSetLink(Link newLink, NotificationChain msgs) {
    Link oldLink = link;
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_LINK_NAME,
          newLink == null ? null : newLink.getName());
    }
    link = newLink;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SOURCE__LINK, oldLink, newLink);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setLink(Link newLink) {
    if (newLink != link) {
      ...
      if (link != null)
        msgs = ((InternalEObject) link).eInverseRemove(this, BPELPackage.LINK__SOURCES,
            Link.class, msgs);
      if (newLink != null)
        msgs = ((InternalEObject) newLink).eInverseAdd(this, BPELPackage.LINK__SOURCES,
            Link.class, msgs);
      msgs = basicSetLink(newLink, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.SOURCE__LINK,
          newLink, newLink));
  }
   ...
   * <!-- end-user-doc -->
   */
  public NotificationChain basicSetTransitionCondition(Condition newTransitionCondition,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.SOURCE__TRANSITION_CONDITION, oldTransitionCondition,
          newTransitionCondition);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setTransitionCondition(Condition newTransitionCondition) {
    if (newTransitionCondition != transitionCondition) {
      ...
      if (transitionCondition != null)
        msgs = ((InternalEObject) transitionCondition)
            .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                - BPELPackage.SOURCE__TRANSITION_CONDITION, null, msgs);
      if (newTransitionCondition != null)
        msgs = ((InternalEObject) newTransitionCondition)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.SOURCE__TRANSITION_CONDITION, newTransitionCondition,
          newTransitionCondition));
  }
