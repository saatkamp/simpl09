  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.TERMINATION_HANDLER__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newActivity != activity) {
      ...
      if (activity != null)
        msgs = ((InternalEObject) activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.TERMINATION_HANDLER__ACTIVITY, null, msgs);
      if (newActivity != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.TERMINATION_HANDLER__ACTIVITY, newActivity, newActivity));
  }
