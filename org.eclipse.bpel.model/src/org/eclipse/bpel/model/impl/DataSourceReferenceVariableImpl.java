 ...
 * </copyright>
 *
 * $Id: DataSourceReferenceVariableImpl.java,v 1.15 2009/04/14 10:50:37 smoser Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DataSourceReferenceVariable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.bpel.model.impl.DataSourceReferenceVariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DataSourceReferenceVariableImpl#getMessageType <em>Message Type</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DataSourceReferenceVariableImpl#getXSDElement <em>XSD Element</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DataSourceReferenceVariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DataSourceReferenceVariableImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataSourceReferenceVariableImpl extends ExtensibleElementImpl implements
   ...
   * @generated
   */
  protected DataSourceReferenceVariableImpl() {
    super();
  }
  ...
  public NotificationChain basicSetFrom(From newFrom, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__FROM, oldFrom, newFrom);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFrom != from) {
      ...
      if (from != null)
        msgs = ((InternalEObject) from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__FROM, null, msgs);
      if (newFrom != null)
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
    case BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__FROM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__NAME:
      return getName();
    case BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__MESSAGE_TYPE:
      if (resolve)
        return getMessageType();
      return basicGetMessageType();
    case BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__XSD_ELEMENT:
      if (resolve)
        return getXSDElement();
      return basicGetXSDElement();
    case BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__TYPE:
      if (resolve)
        return getType();
      return basicGetType();
    case BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__FROM:
...
} // DataSourceReferenceVariableImpl
