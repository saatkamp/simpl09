...
public class LinkImpl extends ExtensibleElementImpl implements Link {
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.LINK__NAME,
          oldName, name));
  }
  ...
  public EList<Source> getSources() {
    if (sources == null) {
      sources = new EObjectWithInverseResolvingEList<Source>(Source.class, this,
          BPELPackage.LINK__SOURCES, BPELPackage.SOURCE__LINK);
    }
    return sources;
  }
  ...
  public EList<Target> getTargets() {
    if (targets == null) {
      targets = new EObjectWithInverseResolvingEList<Target>(Target.class, this,
          BPELPackage.LINK__TARGETS, BPELPackage.TARGET__LINK);
    }
    return targets;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
    ...
    case BPELPackage.LINK__SOURCES:
      return ((InternalEList<InternalEObject>) (InternalEList<?>) getSources()).basicAdd(
          otherEnd, msgs);
    case BPELPackage.LINK__TARGETS:
      return ((InternalEList<InternalEObject>) (InternalEList<?>) getTargets()).basicAdd(
          otherEnd, msgs);
    }
