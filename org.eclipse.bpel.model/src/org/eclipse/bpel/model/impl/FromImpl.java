...
public class FromImpl extends ExtensibleElementImpl implements From {
  ...
  public void setOpaque(Boolean newOpaque) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_OPAQUE,
          BPELUtils.boolean2XML(newOpaque));
    }
    opaque = newOpaque;
    boolean oldOpaqueESet = opaqueESet;
    opaqueESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__OPAQUE,
          oldOpaque, opaque, !oldOpaqueESet));
  }
  ...
  public void unsetOpaque() {
    ...
    opaqueESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, BPELPackage.FROM__OPAQUE,
          oldOpaque, OPAQUE_EDEFAULT, oldOpaqueESet));
  }
  ...
  public void setEndpointReference(EndpointReferenceRole newEndpointReference) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_ENDPOINT_REFERENCE,
          newEndpointReference == null ? ENDPOINT_REFERENCE_EDEFAULT.toString()
              : newEndpointReference.toString());
    }
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FROM__ENDPOINT_REFERENCE, oldEndpointReference, endpointReference,
          !oldEndpointReferenceESet));
  }
  ...
  public void setLiteral(String newLiteral) {
    ...
    literalESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__LITERAL,
          oldLiteral, literal, !oldLiteralESet));
  }
  ...
  public void unsetLiteral() {
    ...
    literalESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, BPELPackage.FROM__LITERAL,
          oldLiteral, LITERAL_EDEFAULT, oldLiteralESet));
  }
  ...
  public void setUnsafeLiteral(Boolean newUnsafeLiteral) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FROM__UNSAFE_LITERAL, oldUnsafeLiteral, unsafeLiteral));
  }
  ...
  public NotificationChain basicSetExpression(Expression newExpression,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FROM__EXPRESSION, oldExpression, newExpression);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newExpression != expression) {
      ...
      if (expression != null)
        msgs = ((InternalEObject) expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.FROM__EXPRESSION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__EXPRESSION,
  ...
  public NotificationChain basicSetServiceRef(ServiceRef newServiceRef,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FROM__SERVICE_REF, oldServiceRef, newServiceRef);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setServiceRef(ServiceRef newServiceRef) {
    if (newServiceRef != serviceRef) {
      NotificationChain msgs = null;
      if (serviceRef != null)
        msgs = ((InternalEObject) serviceRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.FROM__SERVICE_REF, null, msgs);
      if (newServiceRef != null)
        msgs = ((InternalEObject) newServiceRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.FROM__SERVICE_REF, null, msgs);
  ...
  public void setType(XSDTypeDefinition newType) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_XSI_TYPE,
          newType == null ? null : newType.getName());
    }
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__TYPE,
          oldType, type));
  }
  ...
  public void setVariable(Variable newVariable) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__VARIABLE,
  ...
  public void setPart(Part newPart) {
    ...
    part = newPart;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__PART,
          oldPart, part));
  }
  ...
  public void setPartnerLink(PartnerLink newPartnerLink) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PARTNER_LINK,
  ...
  public void setProperty(Property newProperty) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PROPERTY,
          newProperty == null ? null : newProperty.getQName());
    }
    property = newProperty;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__PROPERTY,
  ...
  public NotificationChain basicSetQuery(Query newQuery, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FROM__QUERY, oldQuery, newQuery);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newQuery != query) {
      ...
      if (query != null)
        msgs = ((InternalEObject) query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.FROM__QUERY, null, msgs);
      if (newQuery != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FROM__QUERY,
          newQuery, newQuery));
  }
