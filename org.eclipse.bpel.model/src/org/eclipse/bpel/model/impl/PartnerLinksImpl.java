...
public class PartnerLinksImpl extends ExtensibleElementImpl implements PartnerLinks {
  ...
  public EList<PartnerLink> getChildren() {
    if (children == null) {
      children = new EObjectContainmentEList<PartnerLink>(PartnerLink.class, this,
  ...
  protected void adoptContent(EReference reference, Object object) {
    if (object instanceof PartnerLink) {
      if (getElement() == null) {
        ReconciliationHelper.getInstance().patchParentElement((PartnerLink) object, this,
            null, BPELConstants.ND_PARTNER_LINKS, BPELConstants.ND_PARTNER_LINK);
      } else {
        ReconciliationHelper.adoptChild(this, children, (PartnerLink) object,
