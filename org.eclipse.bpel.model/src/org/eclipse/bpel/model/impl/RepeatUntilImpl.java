...
public class RepeatUntilImpl extends ActivityImpl implements RepeatUntil {
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.REPEAT_UNTIL__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newActivity != activity) {
      ...
      if (activity != null)
        msgs = ((InternalEObject) activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.REPEAT_UNTIL__ACTIVITY, null, msgs);
      if (newActivity != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.REPEAT_UNTIL__ACTIVITY, newActivity, newActivity));
  }
  ...
  public NotificationChain basicSetCondition(Condition newCondition,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.REPEAT_UNTIL__CONDITION, oldCondition, newCondition);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCondition != condition) {
      ...
      if (condition != null)
        msgs = ((InternalEObject) condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.REPEAT_UNTIL__CONDITION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.REPEAT_UNTIL__CONDITION, newCondition, newCondition));
  }
