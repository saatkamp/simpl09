...
public class FlowImpl extends ActivityImpl implements Flow {
  ...
  public NotificationChain basicSetLinks(Links newLinks, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FLOW__LINKS, oldLinks, newLinks);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setLinks(Links newLinks) {
    if (newLinks != links) {
      ...
      if (links != null)
        msgs = ((InternalEObject) links).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.FLOW__LINKS, null, msgs);
      if (newLinks != null)
        msgs = ((InternalEObject) newLinks).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.FLOW__LINKS, null, msgs);
      msgs = basicSetLinks(newLinks, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.FLOW__LINKS,
          newLinks, newLinks));
  }
  ...
  public NotificationChain basicSetCompletionCondition(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FLOW__COMPLETION_CONDITION, oldCompletionCondition,
          newCompletionCondition);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newCompletionCondition != completionCondition) {
      ...
      if (completionCondition != null)
        msgs = ((InternalEObject) completionCondition).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FLOW__COMPLETION_CONDITION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FLOW__COMPLETION_CONDITION, newCompletionCondition,
          newCompletionCondition));
  }
