...
public class InvokeImpl extends PartnerActivityImpl implements Invoke {
      ...
      if (outputVariable != oldOutputVariable) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.INVOKE__OUTPUT_VARIABLE, oldOutputVariable, outputVariable));
      }
    }
  ...
  public void setOutputVariable(Variable newOutputVariable) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_OUTPUT_VARIABLE,
  ...
  public Variable getInputVariable() {
    if (inputVariable != null && inputVariable.eIsProxy()) {
      ...
      if (inputVariable != oldInputVariable) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.INVOKE__INPUT_VARIABLE, oldInputVariable, inputVariable));
      }
    }
  ...
  public void setInputVariable(Variable newInputVariable) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_INPUT_VARIABLE,
  ...
  public NotificationChain basicSetCompensationHandler(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.INVOKE__COMPENSATION_HANDLER, oldCompensationHandler,
  ...
  public void setCompensationHandler(CompensationHandler newCompensationHandler) {
    if (newCompensationHandler != compensationHandler) {
      ...
      if (compensationHandler != null)
        msgs = ((InternalEObject) compensationHandler)
            .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                - BPELPackage.INVOKE__COMPENSATION_HANDLER, null, msgs);
      if (newCompensationHandler != null)
        msgs = ((InternalEObject) newCompensationHandler)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.INVOKE__COMPENSATION_HANDLER, newCompensationHandler,
          newCompensationHandler));
  }
  ...
  public NotificationChain basicSetFaultHandler(FaultHandler newFaultHandler,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.INVOKE__FAULT_HANDLER, oldFaultHandler, newFaultHandler);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setFaultHandler(FaultHandler newFaultHandler) {
    if (newFaultHandler != faultHandler) {
      ...
      if (faultHandler != null)
        msgs = ((InternalEObject) faultHandler).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.INVOKE__FAULT_HANDLER, null, msgs);
      if (newFaultHandler != null)
        msgs = ((InternalEObject) newFaultHandler).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.INVOKE__FAULT_HANDLER, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.INVOKE__FAULT_HANDLER, newFaultHandler, newFaultHandler));
  }
  ...
  public NotificationChain basicSetFromParts(FromParts newFromParts,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.INVOKE__FROM_PARTS, oldFromParts, newFromParts);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public NotificationChain basicSetToParts(ToParts newToParts, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.INVOKE__TO_PARTS, oldToParts, newToParts);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setToParts(ToParts newToParts) {
    if (newToParts != toParts) {
      NotificationChain msgs = null;
      if (toParts != null)
        msgs = ((InternalEObject) toParts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.INVOKE__TO_PARTS, null, msgs);
      if (newToParts != null)
        msgs = ((InternalEObject) newToParts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.INVOKE__TO_PARTS, null, msgs);
      msgs = basicSetToParts(newToParts, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.INVOKE__TO_PARTS,
          newToParts, newToParts));
  }
