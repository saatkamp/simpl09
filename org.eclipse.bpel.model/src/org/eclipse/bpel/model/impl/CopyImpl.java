...
public class CopyImpl extends ExtensibleElementImpl implements Copy {
  ...
  public NotificationChain basicSetTo(To newTo, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.COPY__TO, oldTo, newTo);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newTo != to) {
      ...
      if (to != null)
        msgs = ((InternalEObject) to).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.COPY__TO, null, msgs);
      if (newTo != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.COPY__TO, newTo,
          newTo));
  }
  ...
  public NotificationChain basicSetFrom(From newFrom, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.COPY__FROM, oldFrom, newFrom);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newFrom != from) {
      ...
      if (from != null)
        msgs = ((InternalEObject) from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.COPY__FROM, null, msgs);
      if (newFrom != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.COPY__FROM,
          newFrom, newFrom));
  }
  ...
  public void setKeepSrcElementName(Boolean newKeepSrcElementName) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_KEEP_SRC_ELEMENT_NAME,
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.COPY__KEEP_SRC_ELEMENT_NAME, oldKeepSrcElementName,
          keepSrcElementName, !oldKeepSrcElementNameESet));
  }
  ...
  public void unsetKeepSrcElementName() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.COPY__KEEP_SRC_ELEMENT_NAME, oldKeepSrcElementName,
          KEEP_SRC_ELEMENT_NAME_EDEFAULT, oldKeepSrcElementNameESet));
  }
  ...
  public void setIgnoreMissingFromData(Boolean newIgnoreMissingFromData) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.COPY__IGNORE_MISSING_FROM_DATA, oldIgnoreMissingFromData,
          ignoreMissingFromData, !oldIgnoreMissingFromDataESet));
  }
  ...
  public void unsetIgnoreMissingFromData() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.COPY__IGNORE_MISSING_FROM_DATA, oldIgnoreMissingFromData,
          IGNORE_MISSING_FROM_DATA_EDEFAULT, oldIgnoreMissingFromDataESet));
  }
