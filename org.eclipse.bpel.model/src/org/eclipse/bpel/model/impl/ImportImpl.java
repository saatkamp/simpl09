...
public class ImportImpl extends ExtensibleElementImpl implements Import {
  ...
  public void setNamespace(String newNamespace) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_NAMESPACE,
          newNamespace);
    }
  ...
  public void setLocation(String newLocation) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.IMPORT__LOCATION,
  ...
  public void setImportType(String newImportType) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_IMPORT_TYPE,
          newImportType);
    }
