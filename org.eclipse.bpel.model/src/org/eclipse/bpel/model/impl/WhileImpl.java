...
public class WhileImpl extends ActivityImpl implements While {
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.WHILE__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newActivity != activity) {
      ...
      if (activity != null)
        msgs = ((InternalEObject) activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.WHILE__ACTIVITY, null, msgs);
      if (newActivity != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.WHILE__ACTIVITY,
  ...
  public NotificationChain basicSetCondition(Condition newCondition,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.WHILE__CONDITION, oldCondition, newCondition);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCondition != condition) {
      ...
      if (condition != null)
        msgs = ((InternalEObject) condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.WHILE__CONDITION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.WHILE__CONDITION,
