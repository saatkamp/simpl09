...
public class TargetImpl extends ExtensibleElementImpl implements Target {
  ...
  public NotificationChain basicSetLink(Link newLink, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.TARGET__LINK, oldLink, newLink);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setLink(Link newLink) {
    if (newLink != link) {
      ...
      if (link != null)
        msgs = ((InternalEObject) link).eInverseRemove(this, BPELPackage.LINK__TARGETS,
            Link.class, msgs);
      if (newLink != null)
        msgs = ((InternalEObject) newLink).eInverseAdd(this, BPELPackage.LINK__TARGETS,
            Link.class, msgs);
      msgs = basicSetLink(newLink, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.TARGET__LINK,
          newLink, newLink));
  }
