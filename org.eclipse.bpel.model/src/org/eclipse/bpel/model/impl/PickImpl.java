...
public class PickImpl extends ActivityImpl implements Pick {
  ...
  public void setCreateInstance(Boolean newCreateInstance) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PICK__CREATE_INSTANCE, oldCreateInstance, createInstance,
  ...
  public void unsetCreateInstance() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.PICK__CREATE_INSTANCE, oldCreateInstance, CREATE_INSTANCE_EDEFAULT,
          oldCreateInstanceESet));
  }
  ...
  public EList<OnMessage> getMessages() {
    if (messages == null) {
      messages = new EObjectContainmentEList<OnMessage>(OnMessage.class, this,
          BPELPackage.PICK__MESSAGES);
    }
    return messages;
  }
