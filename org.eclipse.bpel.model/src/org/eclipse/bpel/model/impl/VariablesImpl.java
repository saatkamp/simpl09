...
public class VariablesImpl extends ExtensibleElementImpl implements Variables {
  ...
  public EList<Variable> getChildren() {
    if (children == null) {
      children = new EObjectContainmentEList<Variable>(Variable.class, this,
          BPELPackage.VARIABLES__CHILDREN);
    }
    return children;
  }
  ...
  protected void adoptContent(EReference reference, Object object) {
    if (object instanceof Variable) {
      if (getElement() == null) {
        ReconciliationHelper.getInstance().patchParentElement((Variable) object, this,
            null, BPELConstants.ND_VARIABLES, BPELConstants.ND_VARIABLE);
      } else {
        ReconciliationHelper.adoptChild(this, children, (Variable) object,
            BPELConstants.ND_VARIABLE);
      }
    }
