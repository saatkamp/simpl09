...
public class OnAlarmImpl extends ExtensibleElementImpl implements OnAlarm {
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_ALARM__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public NotificationChain basicSetFor(Expression newFor, NotificationChain msgs) {
    ...
    if (!isReconciling) {
      if (newFor != null && newFor.getElement() == null
        ...
        newFor.setElement(ElementFactory.getInstance().createExpressionElement(newFor,
            this, BPELConstants.ND_FOR));
      }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_ALARM__FOR, oldFor, newFor);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setFor(Expression newFor) {
    if (newFor != for_) {
      NotificationChain msgs = null;
      if (for_ != null)
        msgs = ((InternalEObject) for_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_ALARM__FOR, null, msgs);
      if (newFor != null)
        msgs = ((InternalEObject) newFor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_ALARM__FOR, null, msgs);
      msgs = basicSetFor(newFor, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.ON_ALARM__FOR,
          newFor, newFor));
  }
  ...
  public NotificationChain basicSetUntil(Expression newUntil, NotificationChain msgs) {
    ...
    if (!isReconciling) {
      if (newUntil != null && newUntil.getElement() == null
          && !ReconciliationHelper.isLoading(this)) {
        newUntil.setElement(ElementFactory.getInstance().createExpressionElement(
            newUntil, this, BPELConstants.ND_UNTIL));
      }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_ALARM__UNTIL, oldUntil, newUntil);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setUntil(Expression newUntil) {
    if (newUntil != until) {
      NotificationChain msgs = null;
      if (until != null)
        msgs = ((InternalEObject) until).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_ALARM__UNTIL, null, msgs);
      if (newUntil != null)
        msgs = ((InternalEObject) newUntil).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_ALARM__UNTIL, null, msgs);
      msgs = basicSetUntil(newUntil, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.ON_ALARM__UNTIL,
          newUntil, newUntil));
  }
  ...
  public NotificationChain basicSetRepeatEvery(Expression newRepeatEvery,
    ...
    if (!isReconciling) {
      if (newRepeatEvery != null && newRepeatEvery.getElement() == null
          && !ReconciliationHelper.isLoading(this)) {
        newRepeatEvery.setElement(ElementFactory.getInstance().createExpressionElement(
            newRepeatEvery, this, BPELConstants.ND_REPEAT_EVERY));
      }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_ALARM__REPEAT_EVERY, oldRepeatEvery, newRepeatEvery);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newRepeatEvery != repeatEvery) {
      ...
      if (repeatEvery != null)
        msgs = ((InternalEObject) repeatEvery).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.ON_ALARM__REPEAT_EVERY, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_ALARM__REPEAT_EVERY, newRepeatEvery, newRepeatEvery));
  }
