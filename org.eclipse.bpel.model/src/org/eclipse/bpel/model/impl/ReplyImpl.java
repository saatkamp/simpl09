...
public class ReplyImpl extends PartnerActivityImpl implements Reply {
  ...
  public void setFaultName(QName newFaultName) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_FAULT_NAME,
          newFaultName == null ? null : newFaultName);
    }
  ...
  public void setVariable(Variable newVariable) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.REPLY__VARIABLE,
  ...
  public NotificationChain basicSetToParts(ToParts newToParts, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.REPLY__TO_PARTS, oldToParts, newToParts);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newToParts != toParts) {
      ...
      if (toParts != null)
        msgs = ((InternalEObject) toParts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.REPLY__TO_PARTS, null, msgs);
      if (newToParts != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.REPLY__TO_PARTS,
  ...
  public MessageExchange getMessageExchange() {
    if (messageExchange != null && messageExchange.eIsProxy()) {
      ...
      if (messageExchange != oldMessageExchange) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.REPLY__MESSAGE_EXCHANGE, oldMessageExchange, messageExchange));
      }
    }
