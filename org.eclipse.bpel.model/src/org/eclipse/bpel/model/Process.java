 ...
 *   <li>{@link org.eclipse.bpel.model.Process#getReferenceVariables <em>Reference Variables</em>}</li>
...
public interface Process extends ExtensibleElement {
  ...
  /**
   * Returns the value of the '<em><b>Reference Variables</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Reference Variables</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Reference Variables</em>' containment reference.
   * @see #setReferenceVariables(ReferenceVariables)
   * @see org.eclipse.bpel.model.BPELPackage#getProcess_ReferenceVariables()
   * @model containment="true"
   * @generated
   */
  ReferenceVariables getReferenceVariables();

  /**
   * Sets the value of the '{@link org.eclipse.bpel.model.Process#getReferenceVariables <em>Reference Variables</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Reference Variables</em>' containment reference.
