...
public class PartnerLinkTypeImpl extends ExtensibilityElementImpl implements
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          PartnerlinktypePackage.PARTNER_LINK_TYPE__NAME, oldName, name));
  }
  ...
  protected void changeAttribute(EAttribute eAttribute) {
    ...
    if (theElement != null) {
      if (eAttribute == null
          || eAttribute == PartnerlinktypePackage.eINSTANCE.getPartnerLinkType_Name())
  ...
  protected void changeReference(EReference eReference) {
    ...
    if (theElement != null) {
      if (eReference == null
          || eReference == PartnerlinktypePackage.eINSTANCE.getPartnerLinkType_Role()) {
