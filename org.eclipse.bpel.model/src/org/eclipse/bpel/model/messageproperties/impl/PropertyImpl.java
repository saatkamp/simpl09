...
public class PropertyImpl extends ExtensibilityElementImpl implements Property {
  ...
  public void reconcileReferences(boolean deep) {
    if (element != null
        && element.hasAttribute(MessagepropertiesConstants.PROPERTY_TYPE_ATTRIBUTE)) {
      Definition definition = getEnclosingDefinition();
      QName qname = createQName(definition,
          element.getAttribute(MessagepropertiesConstants.PROPERTY_TYPE_ATTRIBUTE));
      if (qname != null) {
        XSDTypeDefinition xsdType = ((DefinitionImpl) definition).resolveTypeDefinition(
  ...
  protected void changeAttribute(EAttribute eAttribute) {
    ...
    if (theElement != null) {
      if (eAttribute == null
          || eAttribute == MessagepropertiesPackage.eINSTANCE.getProperty_Name())
        niceSetAttribute(theElement, MessagepropertiesConstants.PROPERTY_NAME_ATTRIBUTE,
            getName());
      if (eAttribute == null
          || eAttribute == MessagepropertiesPackage.eINSTANCE.getProperty_Type()) {
        Object type = getType();
        if (type instanceof XSDTypeDefinition) {
          ...
          niceSetAttributeURIValue(theElement,
              MessagepropertiesConstants.PROPERTY_TYPE_ATTRIBUTE, uri);
        }
      }
    }
  }
