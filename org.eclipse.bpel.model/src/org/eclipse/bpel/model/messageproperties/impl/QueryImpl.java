...
public class QueryImpl extends ExtensibilityElementImpl implements Query {
  ...
  public void setQueryLanguage(String newQueryLanguage) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          MessagepropertiesPackage.QUERY__QUERY_LANGUAGE, oldQueryLanguage, queryLanguage));
  }
  ...
  public void reconcileAttributes(Element changedElement) {
    ...
    setQueryLanguage(MessagepropertiesConstants.getAttribute(changedElement,
  ...
  protected void changeAttribute(EAttribute eAttribute) {
    ...
    if (theElement != null) {
      if (eAttribute == null
          || eAttribute == MessagepropertiesPackage.eINSTANCE.getQuery_QueryLanguage())
        niceSetAttribute(theElement,
            MessagepropertiesConstants.QUERY_QUERYLANGUAGE_ATTRIBUTE, getQueryLanguage());
    }
  }
  ...
  public Element createElement() {
    ...
    if (value != null) {
      CDATASection cdata = getEnclosingDefinition().getDocument().createCDATASection(
          value);
