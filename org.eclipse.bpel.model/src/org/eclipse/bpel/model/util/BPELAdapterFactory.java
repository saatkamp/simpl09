...
public class BPELAdapterFactory extends AdapterFactoryImpl {
  ...
  protected BPELSwitch<Adapter> modelSwitch = new BPELSwitch<Adapter>() {
    ...
    @Override
    public Adapter caseUnknownExtensibilityAttribute(UnknownExtensibilityAttribute object) {
    ...
    @Override
    public Adapter caseReferenceVariables(ReferenceVariables object) {
      return createReferenceVariablesAdapter();
    }
    ...
    @Override
    public Adapter caseWSDL_ExtensibleElement(
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.bpel.model.ReferenceVariable <em>Reference Variable</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.bpel.model.ReferenceVariables <em>Reference Variables</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
