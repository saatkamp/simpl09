...
import org.eclipse.bpel.dmextension.ui.factories.DMextensionUIAdapterFactory;
import org.eclipse.bpel.dmextension.ui.DMextensionUIConstants;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.bpel.dmextension.ui";
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		BPELUtil.registerAdapterFactory(ModelPackage.eINSTANCE, new DMextensionUIAdapterFactory());
	}
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		...
		Field fields[] = DMextensionUIConstants.class.getFields();	
	...
	private void createImageDescriptor(String id, URL baseURL) {
		URL url = null;
		try {
			url = new URL(baseURL, DMextensionUIConstants.ICON_PATH + id);
