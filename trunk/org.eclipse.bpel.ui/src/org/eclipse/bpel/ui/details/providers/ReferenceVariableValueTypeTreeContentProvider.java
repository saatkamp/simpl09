 ...
 */
public class ReferenceVariableValueTypeTreeContentProvider extends ModelTreeContentProvider {
	...
	public ReferenceVariableValueTypeTreeContentProvider(boolean isCondensed, boolean displayParticles) {
		super(isCondensed);
