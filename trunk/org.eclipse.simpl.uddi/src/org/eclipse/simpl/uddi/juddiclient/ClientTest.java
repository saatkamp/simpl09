...
//		service.addDescription("Mysql Datenbank", "ger");
//		service.addName("Database Mysql", "ger");
//		service.setKey(KEYPREFIX + "source1");
//		
//		UDDIService service2 = new UDDIService(business.getKey());
//		service2.addDescription("Mysql Datenbank", "ger");
//		service2.addName("Filesystem Ext3", "ger");
//		service2.setKey(KEYPREFIX + "source2");		
