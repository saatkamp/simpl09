...
public class ProcessImpl extends ExtensibleElementImpl implements
	...
	public NotificationChain basicSetReferenceVariables(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, BPELPackage.PROCESS__REFERENCE_VARIABLES,
					oldReferenceVariables, newReferenceVariables);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setReferenceVariables(ReferenceVariables newReferenceVariables) {
		if (newReferenceVariables != referenceVariables) {
			...
			if (referenceVariables != null)
				msgs = ((InternalEObject) referenceVariables).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- BPELPackage.PROCESS__REFERENCE_VARIABLES,
						null, msgs);
			if (newReferenceVariables != null)
				msgs = ((InternalEObject) newReferenceVariables).eInverseAdd(
						this, EOPPOSITE_FEATURE_BASE
								- BPELPackage.PROCESS__REFERENCE_VARIABLES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					BPELPackage.PROCESS__REFERENCE_VARIABLES,
					newReferenceVariables, newReferenceVariables));
	}
