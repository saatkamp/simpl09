 ...
 * <ul>
 *   <li>{@link org.eclipse.simpl.rrs.model.rrs.impl.ReferenceParametersImpl#getReferenceName <em>Reference Name</em>}</li>
 *   <li>{@link org.eclipse.simpl.rrs.model.rrs.impl.ReferenceParametersImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceParametersImpl extends EObjectImpl implements ReferenceParameters {
	...
	protected EClass eStaticClass() {
		return RRSPackage.Literals.REFERENCE_PARAMETERS;
	}
	...
	public void setReferenceName(String newReferenceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RRSPackage.REFERENCE_PARAMETERS__REFERENCE_NAME, oldReferenceName, referenceName));
	}
	...
	public void setStatement(String newStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RRSPackage.REFERENCE_PARAMETERS__STATEMENT, oldStatement, statement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RRSPackage.REFERENCE_PARAMETERS__REFERENCE_NAME:
				return getReferenceName();
			case RRSPackage.REFERENCE_PARAMETERS__STATEMENT:
				return getStatement();
		}
