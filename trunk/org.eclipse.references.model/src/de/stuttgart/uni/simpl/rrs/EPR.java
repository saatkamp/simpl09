 ...
 * <ul>
 *   <li>{@link de.stuttgart.uni.simpl.rrs.EPR#getAddress <em>Address</em>}</li>
 *   <li>{@link de.stuttgart.uni.simpl.rrs.EPR#getReferenceProperties <em>Reference Properties</em>}</li>
 *   <li>{@link de.stuttgart.uni.simpl.rrs.EPR#getReferenceParameters <em>Reference Parameters</em>}</li>
 *   <li>{@link de.stuttgart.uni.simpl.rrs.EPR#getPortType <em>Port Type</em>}</li>
 *   <li>{@link de.stuttgart.uni.simpl.rrs.EPR#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.stuttgart.uni.simpl.rrs.EPR#getPolicy <em>Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR()
...
public interface EPR extends EObject {
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR_Address()
	...
	/**
	 * Sets the value of the '{@link de.stuttgart.uni.simpl.rrs.EPR#getAddress <em>Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR_ReferenceProperties()
	...
	/**
	 * Sets the value of the '{@link de.stuttgart.uni.simpl.rrs.EPR#getReferenceProperties <em>Reference Properties</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR_ReferenceParameters()
	...
	/**
	 * Sets the value of the '{@link de.stuttgart.uni.simpl.rrs.EPR#getReferenceParameters <em>Reference Parameters</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR_PortType()
	...
	/**
	 * Sets the value of the '{@link de.stuttgart.uni.simpl.rrs.EPR#getPortType <em>Port Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR_ServiceName()
	...
	/**
	 * Sets the value of the '{@link de.stuttgart.uni.simpl.rrs.EPR#getServiceName <em>Service Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#getEPR_Policy()
	...
	/**
	 * Sets the value of the '{@link de.stuttgart.uni.simpl.rrs.EPR#getPolicy <em>Policy</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
