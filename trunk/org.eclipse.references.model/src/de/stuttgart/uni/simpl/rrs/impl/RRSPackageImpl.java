...
import de.stuttgart.uni.simpl.rrs.DocumentRoot;
import de.stuttgart.uni.simpl.rrs.RRSFactory;
...
public class RRSPackageImpl extends EPackageImpl implements RRSPackage {
	 ...
	 * @see de.stuttgart.uni.simpl.rrs.RRSPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(eprEClass, de.stuttgart.uni.simpl.rrs.EPR.class, "EPR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEPR_Address(), theXMLTypePackage.getAnyURI(), "address", null, 1, 1, de.stuttgart.uni.simpl.rrs.EPR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEPR_ReferenceProperties(), this.getReferenceProperties(), null, "referenceProperties", null, 1, 1, de.stuttgart.uni.simpl.rrs.EPR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEPR_ReferenceParameters(), theXMLTypePackage.getString(), "referenceParameters", null, 1, 1, de.stuttgart.uni.simpl.rrs.EPR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEPR_PortType(), theXMLTypePackage.getQName(), "portType", null, 0, 1, de.stuttgart.uni.simpl.rrs.EPR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEPR_ServiceName(), this.getServiceName(), null, "serviceName", null, 0, 1, de.stuttgart.uni.simpl.rrs.EPR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEPR_Policy(), theXMLTypePackage.getString(), "policy", null, 0, 1, de.stuttgart.uni.simpl.rrs.EPR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
