    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.simpl.resource.framework.simpl.core.client.DatasourceService_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.simpl.resource.framework.simpl.core.client.DatasourceService_Service.class.getResource(".");
