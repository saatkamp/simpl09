...
public class ReferenceVariablesImpl extends ExtensibleElementImpl implements
	...
	public EList<ReferenceVariable> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<ReferenceVariable>(
					ReferenceVariable.class, this,
					BPELPackage.REFERENCE_VARIABLES__CHILDREN);
		}
		return children;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case BPELPackage.REFERENCE_VARIABLES__CHILDREN:
			getChildren().clear();
			getChildren().addAll(
					(Collection<? extends ReferenceVariable>) newValue);
			return;
		}
		...
		if (object instanceof ReferenceVariable) {
			if (getElement() == null) {
				ReconciliationHelper.getInstance().patchParentElement(
						(ReferenceVariable) object, this, null,
						BPELConstants.ND_REFERENCE_VARIABLES, BPELConstants.ND_REFERENCE_VARIABLE);
			} else {
				ReconciliationHelper.adoptChild(this, children,
						(ReferenceVariable) object, BPELConstants.ND_REFERENCE_VARIABLE);
			}
		}
