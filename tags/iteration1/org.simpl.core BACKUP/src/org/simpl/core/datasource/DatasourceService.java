...
/**
 * <p>
 * Defines the methods that a data source service provider must implement to
 * work with underlying data source.
 * </p>
 * 
 * @author hahnml
 */
public interface DatasourceService {
	 ...
	 * @param statement
	 *            to send.
	 * @return If the statement was correctly send and processed on the data
	 *         source.
	 * @throws ConnectionException
	 *             if any connection problem occurs.
	 * @throws DataException
	 *             if statement processing fails.
	 */
	 ...
	 *            to send.
	 * @param data
	 *            for processing the statement on the data source.
	 * @return If the statement was correctly send and processed on the data
	 *         source.
	 * @throws ConnectionException
	 *             if any connection problem occurs.
	 ...
	 * @param statement
	 *            to send.
	 * @return The data which is processed by the statement from the data
	 *         source.
	 * @throws ConnectionException
	 *             if any connection problem occurs.
	 * @throws DataException
	...
	/**
	 * Sends and executes a statement and corresponding data to a connected data
	 * source.
	 * 
	 * @param dsAddress
	 *            The address of the datasource.
