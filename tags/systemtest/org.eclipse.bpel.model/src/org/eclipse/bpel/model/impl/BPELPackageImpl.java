...
public class BPELPackageImpl extends EPackageImpl implements BPELPackage {
	...
	public EAttribute getReferenceVariable_Name() {
		return (EAttribute) referenceVariableEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getReferenceVariable_ValueType() {
		return (EReference) referenceVariableEClass.getEStructuralFeatures()
				.get(1);
	}
	...
	public EReference getReferenceVariables_Children() {
		return (EReference) referenceVariablesEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(referenceVariableEClass,
				REFERENCE_VARIABLE__VALUE_TYPE);
		createEAttribute(referenceVariableEClass,
				REFERENCE_VARIABLE__REFERENCE_TYPE);
		createEAttribute(referenceVariableEClass, REFERENCE_VARIABLE__PERIOD);
		createEReference(referenceVariableEClass,
				REFERENCE_VARIABLE__PARTNER_LINK);

		referenceVariablesEClass = createEClass(REFERENCE_VARIABLES);
		createEReference(referenceVariablesEClass,
				REFERENCE_VARIABLES__CHILDREN);
	...
	public void initializePackageContents() {
		...
		referenceVariableEClass.getESuperTypes().add(
				this.getExtensibleElement());
		referenceVariablesEClass.getESuperTypes().add(
				this.getExtensibleElement());
		...
		initEClass(
				referenceVariablesEClass,
				ReferenceVariables.class,
