...
public class ResourceDiscoverySettingsComposite extends AAdminConsoleComposite {
  ...
  private String dAddress = "http://localhost:8080/axis2/services/ResourceDiscoveryService.ResourceDiscoveryPort?wsdl";
  ...
  public void createComposite(Composite composite) {
    ...
    addressLabel.setText("Address of the Resource Discovery web service:");
  ...
  public void loadSettings(String parentItem, String item) {
    ...
    if (!settings.isEmpty()) {
      ...
      this.bAddress = "http://localhost:8080/axis2/services/ResourceDiscoveryService.ResourceDiscoveryPort?wsdl";
      this.bMode = "inactive";
    }
