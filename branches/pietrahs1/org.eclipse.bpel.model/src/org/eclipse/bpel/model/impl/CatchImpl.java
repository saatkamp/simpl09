...
public class CatchImpl extends ExtensibleElementImpl implements Catch {
  ...
  public void setFaultName(QName newFaultName) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_FAULT_NAME,
          newFaultName);
    }
  ...
  public NotificationChain basicSetFaultVariable(Variable newFaultVariable,
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_FAULT_VARIABLE,
          newFaultVariable == null ? null : newFaultVariable.getName());
    }
    faultVariable = newFaultVariable;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.CATCH__FAULT_VARIABLE, oldFaultVariable, newFaultVariable);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setFaultVariable(Variable newFaultVariable) {
    if (newFaultVariable != faultVariable) {
      ...
      if (faultVariable != null)
        msgs = ((InternalEObject) faultVariable).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.CATCH__FAULT_VARIABLE, null, msgs);
      if (newFaultVariable != null)
        msgs = ((InternalEObject) newFaultVariable).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.CATCH__FAULT_VARIABLE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.CATCH__FAULT_VARIABLE, newFaultVariable, newFaultVariable));
  }
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.CATCH__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newActivity != activity) {
      ...
      if (activity != null)
        msgs = ((InternalEObject) activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.CATCH__ACTIVITY, null, msgs);
      if (newActivity != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.CATCH__ACTIVITY,
  ...
  public void setFaultMessageType(Message newFaultMessageType) {
    ...
    Message oldFaultMessageType = faultMessageType;
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_FAULT_MESSAGE_TYPE,
          newFaultMessageType == null ? null : newFaultMessageType.getQName());
    }
    faultMessageType = newFaultMessageType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.CATCH__FAULT_MESSAGE_TYPE, oldFaultMessageType, faultMessageType));
  }
  ...
  public XSDElementDeclaration getFaultElement() {
    ...
    if (faultElement != null && faultElement.eIsProxy()) {
      ...
      if (faultElement != oldFaultElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.CATCH__FAULT_ELEMENT, oldFaultElement, faultElement));
      }
    }
    return faultElement;
  }
  ...
  public void setFaultElement(XSDElementDeclaration newFaultElement) {
    ...
    XSDElementDeclaration oldFaultElement = faultElement;
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_FAULT_ELEMENT,
          newFaultElement == null ? null : new QName(
              newFaultElement.getTargetNamespace(), newFaultElement.getName()));
    }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
    case BPELPackage.CATCH__FAULT_NAME:
      return FAULT_NAME_EDEFAULT == null ? faultName != null : !FAULT_NAME_EDEFAULT
          .equals(faultName);
    case BPELPackage.CATCH__FAULT_VARIABLE:
