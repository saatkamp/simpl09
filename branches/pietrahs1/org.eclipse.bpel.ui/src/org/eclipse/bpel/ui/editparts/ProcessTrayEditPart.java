...
public class ProcessTrayEditPart extends MainTrayEditPart implements IHoverHelperSupport {
	...
	protected List<?> getModelChildren() {
		...
		ReferenceVariables referenceVariables = getReferenceVariables();
	...
	protected ReferenceVariables getReferenceVariables() {
		...
		if (process.getReferenceVariables() == null) {
			process.setReferenceVariables(  BPELFactory.eINSTANCE.createReferenceVariables()  );
		}
			...
			selectionListener = new ISelectionChangedListener() {
				...
				protected boolean shouldRefresh(Object currentSelection) {
					...
					if (currentSelection instanceof Variables || currentSelection instanceof Variable)
						return false;
					if (currentSelection instanceof ReferenceVariables || currentSelection instanceof ReferenceVariable)
						return false;
