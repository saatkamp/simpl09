...
/**
 * ReferenceVariableTypeSection provides viewing and editing of the value type of a ReferenceVariable
 */
public class ReferenceVariableTypeSection extends BPELPropertySection {
	...
	protected ReferenceVariableTypeSelector variableTypeSelector;
	
	protected Composite parentComposite;
	
	protected boolean isTypeAffected(Notification n) {
		return (n.getFeatureID(ReferenceVariable.class) == BPELPackage.REFERENCE_VARIABLE__VALUE_TYPE);
	}
	
	protected boolean isElementAffected(Notification n) {
		return (n.getFeatureID(ReferenceVariable.class) == BPELPackage.REFERENCE_VARIABLE__ELEMENT);
	}
	...
	public class ReferenceVariableTypeCallback implements ReferenceVariableTypeSelector.Callback {
		...
		public void selectXSDType(XSDTypeDefinition xsdType) {
	    	...
	    	Command cmd = new SetReferenceVariableValueTypeCommand(variable, xsdType);
	...
	protected void createClient(Composite parent) {
		...
		variableTypeSelector = new ReferenceVariableTypeSelector(composite, SWT.NONE, getBPELEditor(),
			fWidgetFactory, new ReferenceVariableTypeCallback(), true);
	...
	public void updateVariableTypeSelector() {
		variableTypeSelector.setVariable((ReferenceVariable)getInput());
		updateMarkers();
	}
