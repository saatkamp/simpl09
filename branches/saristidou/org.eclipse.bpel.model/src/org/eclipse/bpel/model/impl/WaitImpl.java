...
public class WaitImpl extends ActivityImpl implements Wait {
  ...
  public NotificationChain basicSetFor(Expression newFor, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.WAIT__FOR, oldFor, newFor);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFor != for_) {
      ...
      if (for_ != null)
        msgs = ((InternalEObject) for_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.WAIT__FOR, null, msgs);
      if (newFor != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.WAIT__FOR,
          newFor, newFor));
  }
  ...
  public NotificationChain basicSetUntil(Expression newUntil, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.WAIT__UNTIL, oldUntil, newUntil);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newUntil != until) {
      ...
      if (until != null)
        msgs = ((InternalEObject) until).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.WAIT__UNTIL, null, msgs);
      if (newUntil != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.WAIT__UNTIL,
          newUntil, newUntil));
  }
