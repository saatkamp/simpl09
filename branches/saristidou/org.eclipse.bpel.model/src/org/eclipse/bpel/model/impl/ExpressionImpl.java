...
public class ExpressionImpl extends ExtensibilityElementImpl implements Expression {
  ...
  public void setBody(Object newBody) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.EXPRESSION__BODY,
          oldBody, body));
  }
  ...
  public void setExpressionLanguage(String newExpressionLanguage) {
    ...
    if (!isReconciling) {
      ReconciliationHelper
          .replaceAttribute(
              BPELUtils.isTransparent(eContainer(), this) ? (WSDLElement) eContainer()
                  : this, BPELConstants.AT_EXPRESSIONLANGUAGE, newExpressionLanguage);
    }
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.EXPRESSION__EXPRESSION_LANGUAGE, oldExpressionLanguage,
  ...
  public void unsetExpressionLanguage() {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(
          BPELUtils.isTransparent(eContainer(), this) ? ((WSDLElement) eContainer())
              : this, BPELConstants.AT_EXPRESSIONLANGUAGE, (String) null);
    }
    boolean oldExpressionLanguageESet = expressionLanguageESet;
  ...
  public void setOpaque(Boolean newOpaque) {
    ...
    if (!isReconciling && getElement() != null) {
      ReconciliationHelper.replaceAttribute(
          BPELUtils.isTransparent(eContainer(), this) ? ((WSDLElement) eContainer())
              : this, BPELConstants.AT_OPAQUE, BPELUtils.boolean2XML(newOpaque));
    }
    opaque = newOpaque;
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.EXPRESSION__OPAQUE, oldOpaque, opaque, !oldOpaqueESet));
  }
  ...
  public void unsetOpaque() {
    ...
    if (!isReconciling && getElement() != null) {
      ReconciliationHelper.replaceAttribute(
          BPELUtils.isTransparent(eContainer(), this) ? ((WSDLElement) eContainer())
              : this, BPELConstants.AT_OPAQUE, (String) null);
    }
    boolean oldOpaqueESet = opaqueESet;
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.EXPRESSION__OPAQUE, oldOpaque, OPAQUE_EDEFAULT, oldOpaqueESet));
  }
