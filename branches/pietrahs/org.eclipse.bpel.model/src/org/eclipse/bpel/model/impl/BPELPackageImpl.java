...
public class BPELPackageImpl extends EPackageImpl implements BPELPackage {
   ...
   * @generated
   */
  private EClass referenceVariablesEClass = null;
  ...
  public static BPELPackage initGen() {
    ...
    PartnerlinktypePackageImpl thePartnerlinktypePackage = (PartnerlinktypePackageImpl) (EPackage.Registry.INSTANCE
        ...
        .getEPackage(PartnerlinktypePackage.eNS_URI) : PartnerlinktypePackage.eINSTANCE);
   ...
   * @generated
   */
  public EReference getProcess_ReferenceVariables() {
  ...
  public EAttribute getProcess_ExitOnStandardFault() {
    return (EAttribute) processEClass.getEStructuralFeatures().get(15);
  }
  ...
  public EAttribute getProcess_AbstractProcessProfile() {
    return (EAttribute) processEClass.getEStructuralFeatures().get(17);
  }
   ...
   * @generated
   */
  public EAttribute getReferenceVariable_Name() {
    return (EAttribute) referenceVariableEClass.getEStructuralFeatures().get(0);
  }
  ...
  public EReference getReferenceVariable_ValueType() {
    return (EReference) referenceVariableEClass.getEStructuralFeatures().get(1);
  }
  ...
  public EAttribute getReferenceVariable_Period() {
    return (EAttribute) referenceVariableEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getReferenceVariable_PartnerLink() {
    return (EReference) referenceVariableEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EClass getReferenceVariables() {
    return referenceVariablesEClass;
  }
   ...
   * @generated
   */
  public EReference getReferenceVariables_Children() {
    return (EReference) referenceVariablesEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents() {
    ...
    createEReference(processEClass, PROCESS__REFERENCE_VARIABLES);
    ...
    createEAttribute(referenceVariableEClass, REFERENCE_VARIABLE__NAME);
    ...
    createEReference(referenceVariableEClass, REFERENCE_VARIABLE__PARTNER_LINK);
  ...
  public void initializePackageContents() {
    ...
    initEReference(
        ...
        this.getReferenceVariables(),
        null,
        "referenceVariables", null, 0, 1, org.eclipse.bpel.model.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEReference(
        getProcess_Activity(),
        this.getActivity(),
        null,
    ...
    initEClass(faultHandlerEClass, FaultHandler.class,
    ...
    initEClass(activityEClass, Activity.class,
    ...
    initEClass(correlationSetEClass, CorrelationSet.class,
    ...
    initEClass(invokeEClass, Invoke.class,
    ...
    initEClass(linkEClass, Link.class,
    ...
    initEClass(catchEClass, Catch.class,
    ...
    initEClass(replyEClass, Reply.class,
    ...
    initEClass(partnerActivityEClass, PartnerActivity.class,
    ...
    initEClass(receiveEClass, Receive.class,
    ...
    initEClass(waitEClass, Wait.class,
    ...
    initEClass(emptyEClass, Empty.class,
        "Empty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

    initEClass(sequenceEClass, Sequence.class,
    ...
    initEClass(whileEClass, While.class,
    ...
    initEClass(pickEClass, Pick.class,
    ...
    initEClass(flowEClass, Flow.class,
    ...
    initEClass(onAlarmEClass, OnAlarm.class,
    ...
    initEClass(assignEClass, Assign.class,
    ...
    initEClass(copyEClass, Copy.class,
    ...
    initEClass(extensionEClass, Extension.class,
    ...
    initEClass(scopeEClass, Scope.class,
    ...
    initEClass(compensateScopeEClass, CompensateScope.class,
    ...
    initEClass(compensationHandlerEClass, CompensationHandler.class,
    ...
    initEClass(fromEClass, From.class,
    ...
    initEClass(onMessageEClass, OnMessage.class,
    ...
    initEClass(booleanExpressionEClass, BooleanExpression.class,
        "BooleanExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

    initEClass(correlationEClass, Correlation.class,
    ...
    initEClass(messageExchangeEClass, MessageExchange.class,
    ...
    initEClass(eventHandlerEClass, EventHandler.class,
    ...
    initEClass(targetEClass, Target.class,
    ...
    initEClass(partnerLinksEClass, PartnerLinks.class,
    ...
    initEClass(messageExchangesEClass, MessageExchanges.class,
    ...
    initEClass(variablesEClass, Variables.class,
    ...
    initEClass(correlationSetsEClass, CorrelationSets.class,
    ...
    initEClass(linksEClass, Links.class,
    ...
    initEClass(catchAllEClass, CatchAll.class,
    ...
    initEClass(correlationsEClass, Correlations.class,
    ...
    initEClass(onEventEClass, OnEvent.class,
    ...
    initEClass(rethrowEClass, Rethrow.class,
    ...
    initEClass(targetsEClass, Targets.class,
    ...
    initEClass(sourcesEClass, Sources.class,
    ...
    initEClass(serviceRefEClass, ServiceRef.class,
    ...
    initEClass(extensionsEClass, Extensions.class,
    ...
    initEClass(extensionActivityEClass, ExtensionActivity.class,
        "ExtensionActivity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

    initEClass(fromPartEClass, FromPart.class,
    ...
    initEClass(toPartEClass, ToPart.class,
    ...
    initEClass(opaqueActivityEClass, OpaqueActivity.class,
        "OpaqueActivity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

    initEClass(forEachEClass, ForEach.class,
    ...
    initEClass(repeatUntilEClass, RepeatUntil.class,
    ...
    initEClass(terminationHandlerEClass, TerminationHandler.class,
    ...
    initEClass(validateEClass, Validate.class,
    ...
    initEClass(elseIfEClass, ElseIf.class,
    ...
    initEClass(elseEClass, Else.class,
    ...
    initEClass(completionConditionEClass, CompletionCondition.class,
    ...
    initEClass(branchesEClass, Branches.class,
    ...
    initEClass(extensibleElementEClass, ExtensibleElement.class,
    ...
    initEClass(compensateEClass, Compensate.class,
        "Compensate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

    initEClass(fromPartsEClass, FromParts.class,
    ...
    initEClass(toPartsEClass, ToParts.class,
    ...
    initEClass(referenceVariableEClass, ReferenceVariable.class,
        "ReferenceVariable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
    initEAttribute(
        getReferenceVariable_Name(),
        ecorePackage.getEString(),
        "name", null, 0, 1, ReferenceVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEReference(
        getReferenceVariable_ValueType(),
        theXSDPackage.getXSDTypeDefinition(),
        null,
        "valueType", null, 0, 1, ReferenceVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEAttribute(
        getReferenceVariable_ReferenceType(),
        this.getReferenceType(),
        "referenceType", null, 0, 1, ReferenceVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEAttribute(
        getReferenceVariable_Period(),
        theEcorePackage.getEInt(),
        "period", null, 0, 1, ReferenceVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEReference(
        getReferenceVariable_PartnerLink(),
        this.getPartnerLink(),
        null,
        "partnerLink", null, 0, 1, ReferenceVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

    initEClass(referenceVariablesEClass, ReferenceVariables.class,
        "ReferenceVariables", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
    initEReference(
        getReferenceVariables_Children(),
        this.getReferenceVariable(),
        null,
    ...
    addEEnumLiteral(correlationPatternEEnum, CorrelationPattern.REQUEST_LITERAL);
    addEEnumLiteral(correlationPatternEEnum, CorrelationPattern.RESPONSE_LITERAL);
    addEEnumLiteral(correlationPatternEEnum, CorrelationPattern.REQUESTRESPONSE_LITERAL);
