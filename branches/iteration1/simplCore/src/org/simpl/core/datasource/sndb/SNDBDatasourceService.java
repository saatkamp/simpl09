 ...
 * supports sensor net databases. 
 * At the moment only the sensor net database TinyDB will be supported.
 * </p>
 * 
 * @author hahnml, StuProA: SIMPL, 25.11.2009
 *
 */
public class SNDBDatasourceService implements DatasourceService {
