 ...
 */
public class SetContainerVariableCommand extends SetCommand {
	...
	public SetContainerVariableCommand(EObject target, ContainerVariable newVariable) {
		this(target,newVariable,ModelHelper.NOT_SPECIFIED);
	}
	
	public SetContainerVariableCommand(EObject target, ContainerVariable newVariable, int direction)  {
