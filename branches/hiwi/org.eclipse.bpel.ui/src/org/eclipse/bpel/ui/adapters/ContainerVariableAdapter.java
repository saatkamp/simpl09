...
import org.eclipse.bpel.ui.editparts.ContainerVariableEditPart;
 ...
 *
 */
public class ContainerVariableAdapter extends AbstractStatefulAdapter implements INamedElement, ILabeledElement,
	...
	ITrayEditPartFactory, IExtensionFactory, IContentProposal, AdapterNotification
{
	...
	public String getName(Object modelObject) {
		return getTarget(modelObject, ContainerVariable.class).getName();
	}
	...
	public void setName(Object modelObject, String name) {
		getTarget(modelObject, ContainerVariable.class).setName(name);
	}
	...
	public boolean isNameAffected(Object modelObject, Notification n) {
		return (n.getFeatureID(ContainerVariable.class) == BPELPackage.CONTAINER_VARIABLE__NAME);
	}
	...
	public EditPart createEditPart(EditPart context, Object model) {
		ContainerVariableEditPart result = new ContainerVariableEditPart();
	...
	public String getDescription() {
		...
		// ContainerVariable v = (ContainerVariable) getTarget ( null, ContainerVariable.class );
		// 
