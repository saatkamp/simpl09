...
<%
  ...
  if (parameters.get("dataSourceReferenceTypeListSubmit") != null
      && parameters.get("dataSourceReferenceTypeListSubmit").equals("Edit") && parameters.get("id") != null) {
    typeDefinition = resourceManagement.getDataSourceReferenceTypeById(Integer.valueOf(parameters.get("id")));
...
%>
<h2>SIMPL Resource Management - Data Source Reference Type Editing</h2>
<a href="index.jsp">Home</a> &gt; <a href="datasourcereferencetype_list.jsp">Data Source Reference Type Management</a> &gt; Data Source Reference Type Editing
<br/><br/>
<form name="dataSourceReferenceTypeForm" action="DataSourceReferenceTypeFormAction" method="post" enctype="multipart/form-data">
...
<input type="submit" name="dataSourceReferenceTypeFormSubmit" value="Save" />
<input type="submit" name="dataSourceReferenceTypeFormSubmit" value="Cancel"/>
</form>
