...
public class CSVWriter implements Closeable {
  ...
  public CSVWriter(Writer writer, char separator, char quotechar) {
    this(writer, separator, quotechar, CSVWriter.DEFAULT_ESCAPE_CHARACTER);
  }
  ...
  public CSVWriter(Writer writer, char separator, char quotechar, char escapechar) {
    this(writer, separator, quotechar, escapechar, CSVWriter.DEFAULT_LINE_END);
  }
  ...
  public CSVWriter(Writer writer, char separator, char quotechar, String lineEnd) {
    this(writer, separator, quotechar, CSVWriter.DEFAULT_ESCAPE_CHARACTER, lineEnd);
  }

  /**
   * Constructs CSVWriter with supplied separator, quote char, escape char and line
   * ending.
   * 
   * @param writer
   *          the writer to an underlying CSV source.
  ...
  public void writeNext(String[] nextLine) {
    ...
    for (int i = 0; i < nextLine.length; i++) {
      ...
      if (quotechar != CSVWriter.NO_QUOTE_CHARACTER) {
        sb.append(quotechar);
      }
  ...
  protected StringBuilder processLine(String nextElement) {
    ...
    for (int j = 0; j < nextElement.length(); j++) {
      ...
      if (escapechar != CSVWriter.NO_ESCAPE_CHARACTER && nextChar == quotechar) {
        sb.append(escapechar).append(nextChar);
      } else if (escapechar != CSVWriter.NO_ESCAPE_CHARACTER && nextChar == escapechar) {
        sb.append(escapechar).append(nextChar);
      } else {
        sb.append(nextChar);
      }
