...
public class OnEventImpl extends ExtensibleElementImpl implements OnEvent {
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public NotificationChain basicSetVariable(Variable newVariable, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__VARIABLE, oldVariable, newVariable);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
      ...
      if (partnerLink != oldPartnerLink) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.ON_EVENT__PARTNER_LINK, oldPartnerLink, partnerLink));
      }
    }
    return partnerLink;
  }
  ...
  public NotificationChain basicSetCorrelations(Correlations newCorrelations,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__CORRELATIONS, oldCorrelations, newCorrelations);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCorrelations != correlations) {
      ...
      if (correlations != null)
        msgs = ((InternalEObject) correlations).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.ON_EVENT__CORRELATIONS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__CORRELATIONS, newCorrelations, newCorrelations));
  }
  ...
  public void setOperation(Operation newOperation) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_OPERATION,
          newOperation == null ? null : newOperation.getName());
    }
  ...
  public void setPortType(PortType newPortType) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PORT_TYPE,
          newPortType == null ? null : newPortType.getQName());
    }
  ...
  public Message getMessageType() {
    ...
    if (messageType != null && messageType.eIsProxy()) {
      ...
      if (messageType != oldMessageType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.ON_EVENT__MESSAGE_TYPE, oldMessageType, messageType));
      }
    }
    return messageType;
  }
  ...
  public NotificationChain basicSetCorrelationSets(CorrelationSets newCorrelationSets,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__CORRELATION_SETS, oldCorrelationSets, newCorrelationSets);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCorrelationSets != correlationSets) {
      ...
      if (correlationSets != null)
        msgs = ((InternalEObject) correlationSets).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.ON_EVENT__CORRELATION_SETS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__CORRELATION_SETS, newCorrelationSets, newCorrelationSets));
  }
  ...
  public NotificationChain basicSetFromParts(FromParts newFromParts,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__FROM_PARTS, oldFromParts, newFromParts);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setFromParts(FromParts newFromParts) {
    if (newFromParts != fromParts) {
      NotificationChain msgs = null;
      if (fromParts != null)
        msgs = ((InternalEObject) fromParts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_EVENT__FROM_PARTS, null, msgs);
      if (newFromParts != null)
        msgs = ((InternalEObject) newFromParts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.ON_EVENT__FROM_PARTS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.ON_EVENT__FROM_PARTS, newFromParts, newFromParts));
  }
  ...
  public MessageExchange getMessageExchange() {
    if (messageExchange != null && messageExchange.eIsProxy()) {
      ...
      if (messageExchange != oldMessageExchange) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.ON_EVENT__MESSAGE_EXCHANGE, oldMessageExchange, messageExchange));
      }
    }
  ...
  public void setMessageExchange(MessageExchange newMessageExchange) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_MESSAGE_EXCHANGE,
          newMessageExchange == null ? null : newMessageExchange.getName());
    }
