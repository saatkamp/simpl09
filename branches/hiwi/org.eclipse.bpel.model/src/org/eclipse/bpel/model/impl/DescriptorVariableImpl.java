 ...
 * </copyright>
 *
 * $Id: DescriptorVariableImpl.java,v 1.15 2009/04/14 10:50:37 smoser Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DescriptorVariable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.bpel.model.impl.DescriptorVariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DescriptorVariableImpl#getMessageType <em>Message Type</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DescriptorVariableImpl#getXSDElement <em>XSD Element</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DescriptorVariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.bpel.model.impl.DescriptorVariableImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptorVariableImpl extends ExtensibleElementImpl implements DescriptorVariable {
  /**
   ...
   * @generated
   */
  protected DescriptorVariableImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return BPELPackage.Literals.DESCRIPTOR_VARIABLE;
  }
  
  /**
   * Finds the variable clone of this descriptor variable.
   * 
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.DESCRIPTOR_VARIABLE__NAME,
          oldName, name));
  }
      ...
      if (messageType != oldMessageType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.DESCRIPTOR_VARIABLE__MESSAGE_TYPE, oldMessageType, messageType));
      }
    }
    return messageType;
  }
  ...
  public XSDElementDeclaration getXSDElement() {
    if (xsdElement != null && xsdElement.eIsProxy()) {
      ...
      if (xsdElement != oldXSDElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.DESCRIPTOR_VARIABLE__XSD_ELEMENT, oldXSDElement, xsdElement));
      }
    }
    return xsdElement;
  }
  ...
  public XSDTypeDefinition getType() {
    if (type != null && type.eIsProxy()) {
      ...
      if (type != oldType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.DESCRIPTOR_VARIABLE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(XSDTypeDefinition newType) {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.DESCRIPTOR_VARIABLE__TYPE,
          oldType, type));
  ...
  public NotificationChain basicSetFrom(From newFrom, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.DESCRIPTOR_VARIABLE__FROM, oldFrom, newFrom);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFrom != from) {
      ...
      if (from != null)
        msgs = ((InternalEObject) from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.DESCRIPTOR_VARIABLE__FROM, null, msgs);
      if (newFrom != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.DESCRIPTOR_VARIABLE__FROM,
          newFrom, newFrom));
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
    case BPELPackage.DESCRIPTOR_VARIABLE__FROM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
    case BPELPackage.DESCRIPTOR_VARIABLE__NAME:
      return getName();
    case BPELPackage.DESCRIPTOR_VARIABLE__MESSAGE_TYPE:
      if (resolve)
        return getMessageType();
      return basicGetMessageType();
    case BPELPackage.DESCRIPTOR_VARIABLE__XSD_ELEMENT:
      if (resolve)
        return getXSDElement();
      return basicGetXSDElement();
    case BPELPackage.DESCRIPTOR_VARIABLE__TYPE:
      if (resolve)
        return getType();
      return basicGetType();
    case BPELPackage.DESCRIPTOR_VARIABLE__FROM:
