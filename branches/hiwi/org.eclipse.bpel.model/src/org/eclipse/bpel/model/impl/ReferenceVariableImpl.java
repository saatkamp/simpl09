      ...
      if (valueType != oldValueType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.REFERENCE_VARIABLE__VALUE_TYPE, oldValueType, valueType));
      }
    }
    return valueType;
  }
  ...
  public void setValueType(XSDTypeDefinition newValueType) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, "valueType",
          newValueType == null ? null : new QName(newValueType.getTargetNamespace(),
  ...
  public void setReferenceType(ReferenceType newReferenceType) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(
          ...
          newReferenceType == null ? REFERENCE_TYPE_EDEFAULT.getName() : newReferenceType
              .getName());
    }
    referenceType = newReferenceType == null ? REFERENCE_TYPE_EDEFAULT : newReferenceType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.REFERENCE_VARIABLE__REFERENCE_TYPE, oldReferenceType, referenceType));
  }
  ...
  public PartnerLink getPartnerLink() {
    if (partnerLink != null && partnerLink.eIsProxy()) {
      ...
      if (partnerLink != oldPartnerLink) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.REFERENCE_VARIABLE__PARTNER_LINK, oldPartnerLink, partnerLink));
      }
    }
    return partnerLink;
  }
