 ...
 *   <li>{@link org.eclipse.bpel.model.impl.ProcessImpl#getReferenceVariables <em>Reference Variables</em>}</li>
...
public class ProcessImpl extends ExtensibleElementImpl implements
  ...
  /**
   * The cached value of the '{@link #getReferenceVariables() <em>Reference Variables</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected ReferenceVariables referenceVariables;
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BPELPackage.PROCESS__NAME,
          oldName, name));
  }
  ...
  public void setTargetNamespace(String newTargetNamespace) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_TARGET_NAMESPACE,
          newTargetNamespace);
    }
    targetNamespace = newTargetNamespace;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__TARGET_NAMESPACE, oldTargetNamespace, targetNamespace));
  }
  ...
  public void setQueryLanguage(String newQueryLanguage) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_QUERYLANGUAGE,
          newQueryLanguage);
    }
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__QUERY_LANGUAGE, oldQueryLanguage, queryLanguage,
          !oldQueryLanguageESet));
  }
  ...
  public void unsetQueryLanguage() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.PROCESS__QUERY_LANGUAGE, oldQueryLanguage, QUERY_LANGUAGE_EDEFAULT,
          oldQueryLanguageESet));
  }
  ...
  public void setExpressionLanguage(String newExpressionLanguage) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_EXPRESSIONLANGUAGE,
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__EXPRESSION_LANGUAGE, oldExpressionLanguage,
          expressionLanguage, !oldExpressionLanguageESet));
  }
  ...
  public void setSuppressJoinFailure(Boolean newSuppressJoinFailure) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_SUPPRESS_JOIN_FAILURE,
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__SUPPRESS_JOIN_FAILURE, oldSuppressJoinFailure,
          suppressJoinFailure, !oldSuppressJoinFailureESet));
  }
  ...
  public void unsetSuppressJoinFailure() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.PROCESS__SUPPRESS_JOIN_FAILURE, oldSuppressJoinFailure,
          SUPPRESS_JOIN_FAILURE_EDEFAULT, oldSuppressJoinFailureESet));
  }
  ...
  public void unsetVariableAccessSerializable() {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this,
          BPELConstants.AT_VARIABLE_ACCESS_SERIALIZABLE, (String) null);
    }
    boolean oldVariableAccessSerializableESet = variableAccessSerializableESet;
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.PROCESS__VARIABLE_ACCESS_SERIALIZABLE,
          oldVariableAccessSerializable, VARIABLE_ACCESS_SERIALIZABLE_EDEFAULT,
          oldVariableAccessSerializableESet));
  }
  ...
  public NotificationChain basicSetPartnerLinks(PartnerLinks newPartnerLinks,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__PARTNER_LINKS, oldPartnerLinks, newPartnerLinks);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newPartnerLinks != partnerLinks) {
      ...
      if (partnerLinks != null)
        msgs = ((InternalEObject) partnerLinks).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PROCESS__PARTNER_LINKS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__PARTNER_LINKS, newPartnerLinks, newPartnerLinks));
  }
  ...
  public NotificationChain basicSetVariables(Variables newVariables,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__VARIABLES, oldVariables, newVariables);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
   ...
   * @generated
   */
  public ReferenceVariables getReferenceVariables() {
   ...
   * @generated
   */
  public NotificationChain basicSetReferenceVariables(
      ReferenceVariables newReferenceVariables, NotificationChain msgs) {
    ReferenceVariables oldReferenceVariables = referenceVariables;
    referenceVariables = newReferenceVariables;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__REFERENCE_VARIABLES, oldReferenceVariables,
          newReferenceVariables);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
   ...
   * @generated
   */
  public void setReferenceVariables(ReferenceVariables newReferenceVariables) {
    if (newReferenceVariables != referenceVariables) {
      NotificationChain msgs = null;
      if (referenceVariables != null)
        msgs = ((InternalEObject) referenceVariables)
            .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                - BPELPackage.PROCESS__REFERENCE_VARIABLES, null, msgs);
      if (newReferenceVariables != null)
        msgs = ((InternalEObject) newReferenceVariables)
            .eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                - BPELPackage.PROCESS__REFERENCE_VARIABLES, null, msgs);
      msgs = basicSetReferenceVariables(newReferenceVariables, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__REFERENCE_VARIABLES, newReferenceVariables,
          newReferenceVariables));
  }
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setActivity(Activity newActivity) {
    if (newActivity != activity) {
      NotificationChain msgs = null;
      if (activity != null)
        msgs = ((InternalEObject) activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - BPELPackage.PROCESS__ACTIVITY, null, msgs);
      if (newActivity != null)
   ...
   * <!-- end-user-doc -->
   */
  public NotificationChain basicSetFaultHandlers(FaultHandler newFaultHandlers,
      NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__FAULT_HANDLERS, oldFaultHandlers, newFaultHandlers);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newFaultHandlers != faultHandlers) {
      ...
      if (faultHandlers != null)
        msgs = ((InternalEObject) faultHandlers).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PROCESS__FAULT_HANDLERS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__FAULT_HANDLERS, newFaultHandlers, newFaultHandlers));
  }
  ...
  public NotificationChain basicSetExtensions(Extensions newExtensions,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__EXTENSIONS, oldExtensions, newExtensions);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setExtensions(Extensions newExtensions) {
    if (newExtensions != extensions) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__EXTENSIONS, newExtensions, newExtensions));
  }
  ...
  public void setExitOnStandardFault(Boolean newExitOnStandardFault) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__EXIT_ON_STANDARD_FAULT, oldExitOnStandardFault,
          exitOnStandardFault));
  }
  ...
  private NotificationChain basicSetMessageExchanges(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__MESSAGE_EXCHANGES, oldMessageExchanges,
          newMessageExchanges);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setMessageExchanges(MessageExchanges newMessageExchanges) {
    if (newMessageExchanges != messageExchanges) {
      ...
      if (messageExchanges != null)
        msgs = ((InternalEObject) messageExchanges).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PROCESS__MESSAGE_EXCHANGES, null, msgs);
      if (newMessageExchanges != null)
        msgs = ((InternalEObject) newMessageExchanges).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PROCESS__MESSAGE_EXCHANGES, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__MESSAGE_EXCHANGES, newMessageExchanges,
          newMessageExchanges));
    //		MessageExchanges oldMessageExchanges = messageExchanges;
    //		if (!isReconciling) {
    //			ReconciliationHelper.replaceChild(this, oldMessageExchanges, newMessageExchanges);
  ...
  public void setAbstractProcessProfile(String newAbstractProcessProfile) {
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_ABSTRACT_PROFILES,
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__ABSTRACT_PROCESS_PROFILE, oldAbstractProcessProfile,
          abstractProcessProfile, !oldAbstractProcessProfileESet));
  }
  ...
  public void unsetAbstractProcessProfile() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.PROCESS__ABSTRACT_PROCESS_PROFILE, oldAbstractProcessProfile,
          ABSTRACT_PROCESS_PROFILE_EDEFAULT, oldAbstractProcessProfileESet));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    case BPELPackage.PROCESS__REFERENCE_VARIABLES:
      return basicSetReferenceVariables(null, msgs);
  ...
  public void eSet(int featureID, Object newValue) {
    ...
    case BPELPackage.PROCESS__VARIABLES:
      ...
      return;
    case BPELPackage.PROCESS__REFERENCE_VARIABLES:
      setReferenceVariables((ReferenceVariables) newValue);
      return;
    case BPELPackage.PROCESS__ACTIVITY:
  ...
  public void eUnset(int featureID) {
    ...
    case BPELPackage.PROCESS__VARIABLES:
      ...
      return;
    case BPELPackage.PROCESS__REFERENCE_VARIABLES:
      setReferenceVariables((ReferenceVariables) null);
      return;
    case BPELPackage.PROCESS__ACTIVITY:
  ...
  public boolean eIsSet(int featureID) {
    ...
    case BPELPackage.PROCESS__REFERENCE_VARIABLES:
      return referenceVariables != null;
    case BPELPackage.PROCESS__ACTIVITY:
    ...
    case BPELPackage.PROCESS__EXIT_ON_STANDARD_FAULT:
      return EXIT_ON_STANDARD_FAULT_EDEFAULT == null ? exitOnStandardFault != null
          : !EXIT_ON_STANDARD_FAULT_EDEFAULT.equals(exitOnStandardFault);
    case BPELPackage.PROCESS__MESSAGE_EXCHANGES:
   ...
   * <!-- end-user-doc -->
   */
  public NotificationChain basicSetEventHandlers(EventHandler newEventHandlers,
      NotificationChain msgs) {
    EventHandler oldEventHandlers = eventHandlers;
    eventHandlers = newEventHandlers;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__EVENT_HANDLERS, oldEventHandlers, newEventHandlers);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newEventHandlers != eventHandlers) {
      ...
      if (eventHandlers != null)
        msgs = ((InternalEObject) eventHandlers).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PROCESS__EVENT_HANDLERS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__EVENT_HANDLERS, newEventHandlers, newEventHandlers));
  }
   ...
   * <!-- end-user-doc -->
   */
  public NotificationChain basicSetCorrelationSets(CorrelationSets newCorrelationSets,
      NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__CORRELATION_SETS, oldCorrelationSets, newCorrelationSets);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCorrelationSets != correlationSets) {
      ...
      if (correlationSets != null)
        msgs = ((InternalEObject) correlationSets).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.PROCESS__CORRELATION_SETS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PROCESS__CORRELATION_SETS, newCorrelationSets, newCorrelationSets));
  }
