...
public class ForEachImpl extends ActivityImpl implements ForEach {
   ...
   * <!-- end-user-doc -->
   */
  public NotificationChain basicSetStartCounterValue(Expression newStartCounterValue,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__START_COUNTER_VALUE, oldStartCounterValue,
  ...
  public void setStartCounterValue(Expression newStartCounterValue) {
    if (newStartCounterValue != startCounterValue) {
      ...
      if (startCounterValue != null)
        msgs = ((InternalEObject) startCounterValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FOR_EACH__START_COUNTER_VALUE, null,
            msgs);
      if (newStartCounterValue != null)
        msgs = ((InternalEObject) newStartCounterValue).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FOR_EACH__START_COUNTER_VALUE, null,
            msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__START_COUNTER_VALUE, newStartCounterValue,
          newStartCounterValue));
  }
   ...
   * <!-- end-user-doc -->
   */
  public NotificationChain basicSetFinalCounterValue(Expression newFinalCounterValue,
      NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__FINAL_COUNTER_VALUE, oldFinalCounterValue,
  ...
  public void setFinalCounterValue(Expression newFinalCounterValue) {
    if (newFinalCounterValue != finalCounterValue) {
      ...
      if (finalCounterValue != null)
        msgs = ((InternalEObject) finalCounterValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FOR_EACH__FINAL_COUNTER_VALUE, null,
            msgs);
      if (newFinalCounterValue != null)
        msgs = ((InternalEObject) newFinalCounterValue).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FOR_EACH__FINAL_COUNTER_VALUE, null,
            msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__FINAL_COUNTER_VALUE, newFinalCounterValue,
          newFinalCounterValue));
  }
  ...
  public void setParallel(Boolean newParallel) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PARALLEL,
  ...
  public NotificationChain basicSetCounterName(Variable newCounterName,
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_COUNTER_NAME,
          newCounterName != null ? newCounterName.getName() : null);
    }
    counterName = newCounterName;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__COUNTER_NAME, oldCounterName, newCounterName);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCounterName != counterName) {
      ...
      if (counterName != null)
        msgs = ((InternalEObject) counterName).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FOR_EACH__COUNTER_NAME, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__COUNTER_NAME, newCounterName, newCounterName));
  }
  ...
  public NotificationChain basicSetCompletionCondition(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__COMPLETION_CONDITION, oldCompletionCondition,
          newCompletionCondition);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newCompletionCondition != completionCondition) {
      ...
      if (completionCondition != null)
        msgs = ((InternalEObject) completionCondition).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - BPELPackage.FOR_EACH__COMPLETION_CONDITION, null,
            msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__COMPLETION_CONDITION, newCompletionCondition,
          newCompletionCondition));
  }
  ...
  public NotificationChain basicSetActivity(Activity newActivity, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          BPELPackage.FOR_EACH__ACTIVITY, oldActivity, newActivity);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public boolean eIsSet(int featureID) {
    ...
    case BPELPackage.FOR_EACH__PARALLEL:
      return PARALLEL_EDEFAULT == null ? parallel != null : !PARALLEL_EDEFAULT
          .equals(parallel);
    case BPELPackage.FOR_EACH__COUNTER_NAME:
