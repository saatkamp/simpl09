...
public class BPELSwitch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    ...
    case BPELPackage.PROCESS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(process);
      if (result == null)
    ...
    case BPELPackage.PARTNER_LINK: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(partnerLink);
      if (result == null)
    ...
    case BPELPackage.FAULT_HANDLER: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(faultHandler);
      if (result == null)
    ...
    case BPELPackage.ACTIVITY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(activity);
      if (result == null)
    ...
    case BPELPackage.CORRELATION_SET: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(correlationSet);
      if (result == null)
    ...
    case BPELPackage.INVOKE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(invoke);
      if (result == null)
    ...
    case BPELPackage.LINK: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(link);
      if (result == null)
    ...
    case BPELPackage.CATCH: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(catch_);
      if (result == null)
    ...
    case BPELPackage.REPLY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(reply);
      if (result == null)
    ...
    case BPELPackage.PARTNER_ACTIVITY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(partnerActivity);
      if (result == null)
    ...
    case BPELPackage.RECEIVE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(receive);
      if (result == null)
    ...
    case BPELPackage.EXIT: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(exit);
      if (result == null)
    ...
    case BPELPackage.THROW: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(throw_);
      if (result == null)
    ...
    case BPELPackage.WAIT: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(wait);
      if (result == null)
    ...
    case BPELPackage.EMPTY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(empty);
      if (result == null)
    ...
    case BPELPackage.SEQUENCE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(sequence);
      if (result == null)
    ...
    case BPELPackage.WHILE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(while_);
      if (result == null)
    ...
    case BPELPackage.PICK: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(pick);
      if (result == null)
    ...
    case BPELPackage.FLOW: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(flow);
      if (result == null)
    ...
    case BPELPackage.ON_ALARM: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(onAlarm);
      if (result == null)
    ...
    case BPELPackage.ASSIGN: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(assign);
      if (result == null)
    ...
    case BPELPackage.COPY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(copy);
      if (result == null)
    ...
    case BPELPackage.EXTENSION: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(extension);
      if (result == null)
    ...
    case BPELPackage.SCOPE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(scope);
      if (result == null)
    ...
    case BPELPackage.COMPENSATE_SCOPE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(compensateScope);
      if (result == null)
    ...
    case BPELPackage.COMPENSATION_HANDLER: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(compensationHandler);
      if (result == null)
    ...
    case BPELPackage.TO: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(to);
      if (result == null)
    ...
    case BPELPackage.FROM: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(from);
      if (result == null)
    ...
    case BPELPackage.ON_MESSAGE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(onMessage);
      if (result == null)
    ...
    case BPELPackage.CORRELATION: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(correlation);
      if (result == null)
    ...
    case BPELPackage.MESSAGE_EXCHANGE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(messageExchange);
      if (result == null)
    ...
    case BPELPackage.EVENT_HANDLER: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(eventHandler);
      if (result == null)
    ...
    case BPELPackage.SOURCE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(source);
      if (result == null)
    ...
    case BPELPackage.TARGET: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(target);
      if (result == null)
    ...
    case BPELPackage.PARTNER_LINKS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(partnerLinks);
      if (result == null)
    ...
    case BPELPackage.MESSAGE_EXCHANGES: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(messageExchanges);
      if (result == null)
    ...
    case BPELPackage.VARIABLES: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(variables);
      if (result == null)
    ...
    case BPELPackage.CORRELATION_SETS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(correlationSets);
      if (result == null)
    ...
    case BPELPackage.LINKS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(links);
      if (result == null)
    ...
    case BPELPackage.CATCH_ALL: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(catchAll);
      if (result == null)
    ...
    case BPELPackage.CORRELATIONS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(correlations);
      if (result == null)
    ...
    case BPELPackage.VARIABLE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(variable);
      if (result == null)
    ...
    case BPELPackage.ON_EVENT: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(onEvent);
      if (result == null)
    ...
    case BPELPackage.IMPORT: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(import_);
      if (result == null)
    ...
    case BPELPackage.RETHROW: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(rethrow);
      if (result == null)
    ...
    case BPELPackage.TARGETS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(targets);
      if (result == null)
    ...
    case BPELPackage.SOURCES: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(sources);
      if (result == null)
    ...
    case BPELPackage.SERVICE_REF: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(serviceRef);
      if (result == null)
    ...
    case BPELPackage.EXTENSIONS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(extensions);
      if (result == null)
    ...
    case BPELPackage.EXTENSION_ACTIVITY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(extensionActivity);
      if (result == null)
    ...
    case BPELPackage.FROM_PART: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(fromPart);
      if (result == null)
    ...
    case BPELPackage.TO_PART: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(toPart);
      if (result == null)
    ...
    case BPELPackage.OPAQUE_ACTIVITY: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(opaqueActivity);
      if (result == null)
    ...
    case BPELPackage.FOR_EACH: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(forEach);
      if (result == null)
    ...
    case BPELPackage.REPEAT_UNTIL: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(repeatUntil);
      if (result == null)
    ...
    case BPELPackage.TERMINATION_HANDLER: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(terminationHandler);
      if (result == null)
    ...
    case BPELPackage.VALIDATE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(validate);
      if (result == null)
    ...
    case BPELPackage.IF: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(if_);
      if (result == null)
    ...
    case BPELPackage.ELSE_IF: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(elseIf);
      if (result == null)
    ...
    case BPELPackage.ELSE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(else_);
      if (result == null)
    ...
    case BPELPackage.COMPLETION_CONDITION: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(completionCondition);
      if (result == null)
    ...
    case BPELPackage.EXTENSIBLE_ELEMENT: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(extensibleElement);
      if (result == null)
    ...
    case BPELPackage.COMPENSATE: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(compensate);
      if (result == null)
    ...
    case BPELPackage.FROM_PARTS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(fromParts);
      if (result == null)
    ...
    case BPELPackage.TO_PARTS: {
      ...
      if (result == null)
        result = caseWSDL_ExtensibleElement(toParts);
      if (result == null)
    ...
    case BPELPackage.REFERENCE_VARIABLE: {
      ReferenceVariable referenceVariable = (ReferenceVariable) theEObject;
      T result = caseReferenceVariable(referenceVariable);
      if (result == null)
        result = caseExtensibleElement(referenceVariable);
      if (result == null)
        result = caseWSDL_ExtensibleElement(referenceVariable);
      if (result == null)
        result = caseWSDLElement(referenceVariable);
      if (result == null)
        result = caseIElementExtensible(referenceVariable);
      if (result == null)
        result = caseIAttributeExtensible(referenceVariable);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case BPELPackage.REFERENCE_VARIABLES: {
      ReferenceVariables referenceVariables = (ReferenceVariables) theEObject;
      T result = caseReferenceVariables(referenceVariables);
      if (result == null)
        result = caseExtensibleElement(referenceVariables);
      if (result == null)
        result = caseWSDL_ExtensibleElement(referenceVariables);
      if (result == null)
        result = caseWSDLElement(referenceVariables);
      if (result == null)
        result = caseIElementExtensible(referenceVariables);
      if (result == null)
        result = caseIAttributeExtensible(referenceVariables);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Reference Variables</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Reference Variables</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseReferenceVariables(ReferenceVariables object) {
    return null;
  }
   ...
   * @generated
   */
  public T caseUnknownExtensibilityAttribute(UnknownExtensibilityAttribute object) {
    return null;
  }
   ...
   * @generated
   */
  public T caseWSDL_ExtensibleElement(org.eclipse.wst.wsdl.ExtensibleElement object) {
    return null;
  }
