 ...
 */
public class SetDataSourceReferenceVariableCommand extends SetCommand {
	...
	public SetDataSourceReferenceVariableCommand(EObject target, DataSourceReferenceVariable newVariable) {
		this(target,newVariable,ModelHelper.NOT_SPECIFIED);
	}
	
	public SetDataSourceReferenceVariableCommand(EObject target, DataSourceReferenceVariable newVariable, int direction)  {
