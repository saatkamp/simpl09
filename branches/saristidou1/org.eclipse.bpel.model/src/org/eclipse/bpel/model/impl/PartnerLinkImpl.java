...
public class PartnerLinkImpl extends ExtensibleElementImpl implements PartnerLink {
  ...
  public void setMyRole(Role newMyRole) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_MY_ROLE,
          newMyRole == null ? null : newMyRole.getName());
    }
    myRole = newMyRole;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
  ...
  public Role getPartnerRole() {
    if (partnerRole != null && partnerRole.eIsProxy()) {
      ...
      if (partnerRole != oldPartnerRole) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.PARTNER_LINK__PARTNER_ROLE, oldPartnerRole, partnerRole));
      }
    }
    return partnerRole;
  }
  ...
  public void setPartnerRole(Role newPartnerRole) {
    ...
    if (!isReconciling) {
      ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PARTNER_ROLE,
  ...
  public PartnerLinkType getPartnerLinkType() {
    if (partnerLinkType != null && partnerLinkType.eIsProxy()) {
      ...
      if (partnerLinkType != oldPartnerLinkType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              BPELPackage.PARTNER_LINK__PARTNER_LINK_TYPE, oldPartnerLinkType,
              partnerLinkType));
      }
    }
  ...
  public void setPartnerLinkType(PartnerLinkType newPartnerLinkType) {
    ...
    if (!isReconciling) {
      ...
      if (newPartnerLinkType == null) {
        ReconciliationHelper.replaceAttribute(this, BPELConstants.AT_PARTNER_LINK_TYPE,
            (String) null);
      } else {
        QName qname = null;
  ...
  public void setInitializePartnerRole(Boolean newInitializePartnerRole) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          BPELPackage.PARTNER_LINK__INITIALIZE_PARTNER_ROLE, oldInitializePartnerRole,
          initializePartnerRole, !oldInitializePartnerRoleESet));
  }
  ...
  public void unsetInitializePartnerRole() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          BPELPackage.PARTNER_LINK__INITIALIZE_PARTNER_ROLE, oldInitializePartnerRole,
          INITIALIZE_PARTNER_ROLE_EDEFAULT, oldInitializePartnerRoleESet));
  }
