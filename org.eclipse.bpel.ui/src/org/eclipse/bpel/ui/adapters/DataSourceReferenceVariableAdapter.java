...
import org.eclipse.bpel.ui.editparts.DataSourceReferenceVariableEditPart;
...
/**
 * DataSourceReferenceVariable adapter.
 * 
 * @author IBM
 ...
 *
 */
public class DataSourceReferenceVariableAdapter extends AbstractStatefulAdapter implements INamedElement, ILabeledElement,
	...
	ITrayEditPartFactory, IExtensionFactory, IContentProposal, AdapterNotification
{
	...
	public String getName(Object modelObject) {
		return getTarget(modelObject, DataSourceReferenceVariable.class).getName();
	}
	...
	public void setName(Object modelObject, String name) {
		getTarget(modelObject, DataSourceReferenceVariable.class).setName(name);
	}
	...
	public boolean isNameAffected(Object modelObject, Notification n) {
		return (n.getFeatureID(DataSourceReferenceVariable.class) == BPELPackage.DATA_SOURCE_REFERENCE_VARIABLE__NAME);
	}
	...
	public String getTypeLabel(Object object) {
		return "Data Source Reference Variable"; 
	}	
	...
	public EditPart createEditPart(EditPart context, Object model) {
		DataSourceReferenceVariableEditPart result = new DataSourceReferenceVariableEditPart();
	...
	public String getDescription() {
		...
		// DataSourceReferenceVariable v = (DataSourceReferenceVariable) getTarget ( null, DataSourceReferenceVariable.class );
		// 
