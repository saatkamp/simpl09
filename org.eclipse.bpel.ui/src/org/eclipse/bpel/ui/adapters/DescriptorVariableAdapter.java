...
import org.eclipse.bpel.ui.editparts.DescriptorVariableEditPart;
 ...
 *
 */
public class DescriptorVariableAdapter extends AbstractStatefulAdapter implements INamedElement, ILabeledElement,
	...
	ITrayEditPartFactory, IExtensionFactory, IContentProposal, AdapterNotification
{
	...
	public String getName(Object modelObject) {
		return getTarget(modelObject, DescriptorVariable.class).getName();
	}
	...
	public void setName(Object modelObject, String name) {
		getTarget(modelObject, DescriptorVariable.class).setName(name);
	}
	...
	public boolean isNameAffected(Object modelObject, Notification n) {
		return (n.getFeatureID(DescriptorVariable.class) == BPELPackage.DESCRIPTOR_VARIABLE__NAME);
	}
	...
	public EditPart createEditPart(EditPart context, Object model) {
		DescriptorVariableEditPart result = new DescriptorVariableEditPart();
	...
	public String getDescription() {
		...
		// DescriptorVariable v = (DescriptorVariable) getTarget ( null, DescriptorVariable.class );
		// 
