...
import org.eclipse.bpel.ui.editparts.ContainerReferenceVariableEditPart;
...
/**
 * ContainerReferenceVariable adapter.
 * 
 * @author IBM
 ...
 *
 */
public class ContainerReferenceVariableAdapter extends AbstractStatefulAdapter implements INamedElement, ILabeledElement,
	...
	ITrayEditPartFactory, IExtensionFactory, IContentProposal, AdapterNotification
{
	...
	public String getName(Object modelObject) {
		return getTarget(modelObject, ContainerReferenceVariable.class).getName();
	}
	...
	public void setName(Object modelObject, String name) {
		getTarget(modelObject, ContainerReferenceVariable.class).setName(name);
	}
	...
	public boolean isNameAffected(Object modelObject, Notification n) {
		return (n.getFeatureID(ContainerReferenceVariable.class) == BPELPackage.CONTAINER_REFERENCE_VARIABLE__NAME);
	}
	...
	public String getTypeLabel(Object object) {
		return "Container Reference Variable"; 
	}	
	...
	public EditPart createEditPart(EditPart context, Object model) {
		ContainerReferenceVariableEditPart result = new ContainerReferenceVariableEditPart();
	...
	public String getDescription() {
		...
		// ContainerReferenceVariable v = (ContainerReferenceVariable) getTarget ( null, ContainerReferenceVariable.class );
		// 
