...
public class SetContainerVariableTypeCommand extends SetCommand {

	public String getDefaultLabel() { return IBPELUIConstants.CMD_EDIT_VARIABLE_TYPE; }

	public SetContainerVariableTypeCommand(ContainerVariable target, EObject newVariableType)  {
		super(target, newVariableType);
	}
	
	@Override
	public Object get() {
		Object o = ((ContainerVariable)fTarget).getMessageType();
		if (o == null) {
			o = ((ContainerVariable)fTarget).getType();
		}
		if (o == null) {
			o = ((ContainerVariable)fTarget).getXSDElement();
		}
		return o;
	}
	...
	public void set(Object o) {
	  ContainerVariable variable = (ContainerVariable)fTarget;
