 ...
 */
public class SetDescriptorVariableCommand extends SetCommand {
	...
	public SetDescriptorVariableCommand(EObject target, DescriptorVariable newVariable) {
		this(target,newVariable,ModelHelper.NOT_SPECIFIED);
	}
	
	public SetDescriptorVariableCommand(EObject target, DescriptorVariable newVariable, int direction)  {
