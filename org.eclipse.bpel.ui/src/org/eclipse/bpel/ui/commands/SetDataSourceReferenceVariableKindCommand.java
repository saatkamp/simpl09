 ...
 */
public class SetDataSourceReferenceVariableKindCommand extends SetCommand {

	public String getDefaultLabel() { return IBPELUIConstants.CMD_EDIT_VARIABLE_TYPE; }

	public SetDataSourceReferenceVariableKindCommand(VariableExtension target, int newKind) {
