 ...
 */
public class SetContainerReferenceVariableKindCommand extends SetCommand {

	public String getDefaultLabel() { return IBPELUIConstants.CMD_EDIT_VARIABLE_TYPE; }

	public SetContainerReferenceVariableKindCommand(VariableExtension target, int newKind) {
