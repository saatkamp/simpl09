 ...
 */
public class SetContainerReferenceVariableCommand extends SetCommand {
	...
	public SetContainerReferenceVariableCommand(EObject target, ContainerReferenceVariable newVariable) {
		this(target,newVariable,ModelHelper.NOT_SPECIFIED);
	}
	
	public SetContainerReferenceVariableCommand(EObject target, ContainerReferenceVariable newVariable, int direction)  {
