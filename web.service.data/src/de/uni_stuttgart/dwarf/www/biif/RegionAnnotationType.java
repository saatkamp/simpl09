 ...
 */
            ...
            /**
            *  RegionAnnotationType bean class
            */
        
        public  class RegionAnnotationType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = regionAnnotationType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.math.BigInteger localStop ;
                           ...
                           */
                           public  java.math.BigInteger getStop(){
                            ...
                            /**
                               ...
                               * @param param Stop
                               */
                               public void setStop(java.math.BigInteger param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RegionAnnotationType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":regionAnnotationType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                          ...
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localStart is null");
                                            ...
                                            if (localStop != null){
                                                ...
                                                writeAttribute("",
                                                         "stop",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localStop), xmlWriter);

                                            
                                      }
                                    
                                      else {
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localStop is null");
                                      }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            new javax.xml.namespace.QName("","stop"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localStop));
    ...
    public static class Factory{
        ...
        */
        public static RegionAnnotationType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegionAnnotationType object =
                new RegionAnnotationType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"regionAnnotationType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RegionAnnotationType)de.uni_stuttgart.dwarf.www.biif.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribStart!=null){
                         java.lang.String content = tempAttribStart;
                                                 ...
                                                 object.setStart(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(tempAttribStart));
                    ...
                    // handle attribute "stop"
                    java.lang.String tempAttribStop =
                        
                                reader.getAttributeValue(null,"stop");
                            
                   if (tempAttribStop!=null){
                         java.lang.String content = tempAttribStop;
                        
                                                 object.setStop(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(tempAttribStop));
                                            
                    } else {
                       
                               throw new org.apache.axis2.databinding.ADBException("Required attribute stop is missing");
                           
                    }
                    handledAttributes.add("stop");
