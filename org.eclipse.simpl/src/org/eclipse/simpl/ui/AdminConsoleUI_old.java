...
import org.eclipse.simpl.Application;
import org.eclipse.simpl.Tuple;
...
public class AdminConsoleUI_old {
	Display display;
	Shell shell;
	Tree tree;
	...
	public AdminConsoleUI_old(Display display) {
		// Container container= new Container();
		// display= new Display();
		shell = new Shell(display);
		shell.setSize(730, 530);
		shell.setText("SIMPL Administration Console");
...
//		for (SelectionListener select : Application.getInstance().getTreeSelectionListener()){
//			tree.addSelectionListener(select);
//		}
