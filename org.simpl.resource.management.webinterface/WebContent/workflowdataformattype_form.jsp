...
<%
  ...
  if (parameters.get("workflowDataFormatTypeListSubmit") != null
      && parameters.get("workflowDataFormatTypeListSubmit").equals("Edit") && parameters.get("id") != null) {
    typeDefinition = resourceManagement.getWorkflowDataFormatTypeById(Integer.valueOf(parameters.get("id")));
...
%>
<h2>SIMPL Resource Management - Workflow Data Format Type Editing</h2>
<a href="index.jsp">Home</a> &gt; <a href="workflowdataformattype_list.jsp">Workflow Data Format Type Management</a> &gt; Workflow Data Format Type Editing
<br/><br/>
<form name="workflowDataFormatTypeForm" action="WorkflowDataFormatTypeFormAction" method="post" enctype="multipart/form-data">
...
<input type="submit" name="workflowDataFormatTypeFormSubmit" value="Save" />
<input type="submit" name="workflowDataFormatTypeFormSubmit" value="Cancel"/>
</form>
