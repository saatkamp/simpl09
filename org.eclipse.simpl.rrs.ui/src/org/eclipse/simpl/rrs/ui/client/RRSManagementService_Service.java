...
public class RRSManagementService_Service extends Service {
	private final static String RRS_MG_WSDL = RRSUIPlugIn.getDefault()
			.getPreferenceStore().getString("RRS_MG_ADDRESS");

	private final static URL RRSMANAGEMENTSERVICE_WSDL_LOCATION;
	private final static Logger logger = Logger
			.getLogger(org.eclipse.simpl.rrs.ui.client.RRSManagementService_Service.class
					.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = RRSManagementService_Service.class.getResource(".");
			url = new URL(
					baseUrl,
					RRS_MG_WSDL);
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: '"+ RRS_MG_WSDL + "', retrying as a local file");
	...
	public RRSManagementService_Service() {
		super(RRSMANAGEMENTSERVICE_WSDL_LOCATION, new QName(
				"http://webservices.rrs.simpl.org/", "RRSManagementService"));
	}

	/**
	 * 
	 * @return returns RRSManagementService
	 */
	@WebEndpoint(name = "RRSManagementServicePort")
	public RRSManagementService getRRSManagementServicePort() {
		return super.getPort(new QName("http://webservices.rrs.simpl.org/",
				"RRSManagementServicePort"), RRSManagementService.class);
	}
